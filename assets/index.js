...
let dt = ot.concat("iframe").join(",");

function ht(t) {
    if (!t) throw new Error("No node provided");
    return !1 !== st.call(t, dt) && lt(t)
}
...
var gt, vt, yt = (vt = [], {
    activateTrap: function(t) {
        ...
        var n = vt.indexOf(t); - 1 === n || vt.splice(n, 1), vt.push(t)
    },
    deactivateTrap: function(t) {
        var e = vt.indexOf(t); - 1 !== e && vt.splice(e, 1), vt.length > 0 && vt[vt.length - 1].unpause()
    }
});
...
function bt(t, e) {
    ...
    function s(t) {
        if (o.active) {
            clearTimeout(gt), u(), o.active = !1, o.paused = !1, yt.deactivateTrap(a);
            var e = t && void 0 !== t.onDeactivate ? t.onDeactivate : i.onDeactivate;
            return e && e(), (t && void 0 !== t.returnFocus ? t.returnFocus : i.returnFocusOnDeactivate) && wt((function() {
                var t;
    ...
    function c() {
        if (o.active) return yt.activateTrap(a), gt = i.delayInitialFocus ? wt((function() {
            v(d())
    ...
    function g() {
        var t = function(t, e) {
            let n = [],
                r = [];
            return ct(t, (e = e || {}).includeContainer, ut).forEach((function(t, e) {
                let i = ft(t);
                0 === i ? n.push(t) : r.push({
                    documentOrder: e,
                    tabIndex: i,
            ...
            })), r.sort(pt).map(t => t.node).concat(n)
        }(r);
...
var _t = n(7),
    ...
    At = (function(t) {
        ...
        e.formats = Object.assign({}, Et, e.formats);
        ...
        return Object(_t.formatMoney)(t, theme.moneyFormat || "${{amount}}")
    }),
    Lt = n(16),
    kt = n.n(Lt);
...
var Ot = n(0),
    ...
    Dt = function(t) {
        ...
        if (!(n.length < 1)) {
            var r = [];
            return Ct()(n).forEach((function(t) {
                    return r.push(Pt.call(e, t))
                })),
                function() {
    ...
    It = function(t) {
        ...
        var e = function(e) {
            var n = e.target;
            Ct()(n.classList).includes("product-form__chip-input") && (t.querySelector(".product-form__chip-selected").innerText = n.value)
        };
    ...
    Rt = function(t, e) {
        var n = t.querySelector(Mt.addButton),
            r = n.querySelector(Mt.addButtonText),
            i = n.dataset,
            o = i.langAvailable,
            a = i.langSoldOut,
            s = i.langUnavailable;
    ...
    Bt = theme.strings.products,
    Ht = Mt,
    zt = "hide",
    Ft = function(t, e) {
        t.querySelector(Ht.comparePrice);
        var n = t.querySelectorAll("".concat(Ht.comparePrice, ", ").concat(Ht.comparePriceText)),
            r = Ct()(t.querySelectorAll(Ht.price)),
            i = Bt.product.unavailable;
        ...
        r.forEach((function(t) {
            return t.innerHTML = At(e.price)
        })), e.compare_at_price > e.price ? (n.forEach((function(t) {
            return t.innerHTML = At(e.compare_at_price)
        })), n.forEach((function(t) {
    ...
    Ut = Mt,
    Vt = function(t, e) {
        var n = t.querySelector("".concat(Ut.imageWrapper, " img"));
        n.srcset = "", n.src = e
    };
...
function Xt(t) {
    Kt("add").apply(void 0, [t].concat([].slice.call(arguments, 1)))
}

function Zt(t) {
    Kt("remove").apply(void 0, [t].concat([].slice.call(arguments, 1)))
}

function Qt(t) {
    Kt("toggle").apply(void 0, [t].concat([].slice.call(arguments, 1)))
}
...
function ie(t, e) {
    return ce().then((function(n) {
        for (var r = n.items, i = 0; i < r.length; i++)
            if (r[i].variant_id === parseInt(t)) return ae(i + 1, e)
    }))
}

function oe(t) {
    return le() && ne() && function(t) {
        var e = ne(),
            n = e.indexOf(t);
        e.splice(n, 1), re(JSON.stringify(e))
    }(t), ie(t, 0)
}

function ae(t, e) {
    return B("cart:updating"), ee("".concat(theme.routes.cart.change, ".js"), {
        method: "POST",
        credentials: "include",
        headers: {
        ...
        return le() && ne() && (t.items = ue(t.items, ne())), H({
            cart: t
        }), B("cart:updated", {
            cart: t
        }), t
...
function se(t, e) {
    ...
    return B("cart:updating"), ee("".concat(theme.routes.cart.add, ".js"), {
        method: "POST",
        credentials: "include",
        headers: {
            "Content-Type": "application/json"
...
function ce(t) {
    return ee("".concat(theme.routes.cart.base, ".js"), {
        method: "GET",
        credentials: "include"
    }).then((function(t) {
        return t.json()
        ...
        if (le()) {
            ...
            if (ne() || re(JSON.stringify(n)), t) {
                var r = n.indexOf(t);
                n.unshift(n.splice(r, 1)[0]), re(JSON.stringify(n)), H({
                    newItemInCart: !0
                })
            }
            e.items = ue(e.items, n)
        }
        return e
    }))
}
...
var de = function(t) {
        return Object(_t.formatMoney)(t, window.theme.moneyFormat || "${{amount}}")
    },
    he = function(t) {
        return function(e) {
    ...
    pe = theme.strings.products,
    me = "[data-unit-price-container]",
    ge = "[data-unit-price]",
    ve = "[data-unit-base]",
    ye = "unit-price--available",
    be = function(t, e) {
        var n = Gt(me, t),
            r = Gt(ge, t),
            i = Gt(ve, t);
        Qt(n, ye, void 0 !== e.unit_price), e.unit_price && (Ee(r, de(e.unit_price)), Ee(i, _e(e.unit_price_measurement)))
    },
    we = function(t, e) {
        if (t && e) {
            var n = pe.product.unitPrice;
...
var Ae = function() {
    ...
    ke = function(t) {
        var e = [];
        null !== Ae() ? ((e = Ae().filter((function(e) {
            return e.id !== t.id
        }))).unshift(t), Le(JSON.stringify(e.slice(0, 20)))) : null === Ae() && (e.push(t), Le(JSON.stringify(e)))
    },
    xe = function() {
        return Ae()
    },
    Te = function(t) {
        ...
        e.addEventListener("click", (function(t) {
            t.preventDefault(), 1 === r ? oe(i) : ie(i, parseInt(r) - 1)
        })), n.addEventListener("click", (function(t) {
            t.preventDefault(), ie(i, parseInt(r) + 1)
        }))
    };
    ...
    return t.length > 0 ? t.reduce((function(t, e) {
        return t += function(t) {
            ...
            var e = t.title,
                n = t.url,
                r = t.featured_image,
                i = kt()(t, ["handle", "title", "url", "featured_image"]),
                o = r && Tt(r.replace("." + xt(r), ""), "200x");
...
var Oe = ".cart__item",
        ...
        var e = bt(t, {
            ...
            d = function(t) {
                ...
                c.classList.add("active"), l.classList.remove("active"), u.classList.remove("active"), i.innerHTML = (e = t.items).length > 0 ? e.reduce((function(t, e) {
                    var n = z().newItemInCart;
                    return n && H({
                        newItemInCart: !1
                    }), t += Se(e, n)
                }), "") : '<p class="quick-cart__empty-state">'.concat(theme.strings.cart.general.empty, "</p>");
                var s = i.querySelectorAll(Oe);
                s.length && s.forEach((function(t) {
                    Te(t)
                })), xe() && u.classList.remove("hide"), n.innerHTML = function(t) {
                    return t.length > 0 ? "\n    <div>\n      ".concat(t.map((function(t) {
                        var e = t.title,
                            n = t.total_allocated_amount;
                        return "<div>".concat(e, " (-").concat(At(n), ")</div>")
                    })), "\n    </div>\n  ") : ""
                }(a), t.items.length > 0 ? o.classList.add("active") : o.classList.remove("active"), Boolean(a.length > 0) ? n.classList.add("active") : n.classList.remove("active"), r && (r.innerHTML = At(t.total_price))
            },
            h = function(n, r) {
                t.classList.add("is-visible"), B("drawerOverlay:show"), t.classList.add("is-active"), i.innerHTML = s, z().quickShopProduct && t.classList.add("has-quick-shop-product"), setTimeout((function() {
                    e.activate(), r ? (l.classList.add("active"), setTimeout(m(), 10)) : (c.classList.add("active"), setTimeout(d(n), 10))
                }), 50)
            },
            f = function() {
                var n = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
                n && B("drawerOverlay:hide"), t.classList.remove("is-visible"), l.classList.remove("active"), u.classList.remove("active"), c.classList.remove("active"), t.classList.remove("has-quick-shop-product"), setTimeout((function() {
                    e.deactivate(), H({
                        cartOpen: !1,
            ...
            p = R("drawerOverlay:hiding", (function() {
                return f(!1)
            })),
            m = function() {
                l.classList.add("active"), c.classList.remove("active"), u.classList.remove("active"), o.classList.remove("active"), i.innerHTML = "", i.appendChild(z().quickShopProduct)
            },
            g = function(t) {
                z().cartOpen && ("Escape" == t.key || 27 === t.keyCode && drawerOpen) && f()
            };
        d(z().cart), c.addEventListener("click", (function(t) {
            ...
            return t.preventDefault() || void((e = xe()) && (c.classList.remove("active"), l.classList.remove("active"), u.classList.add("active"), o.classList.remove("active"), i.innerHTML = qe(e)));
            var e
        })), l.addEventListener("click", (function(t) {
            return t.preventDefault() || m()
        })), a.addEventListener("click", f), R("cart:toggle", (function(t) {
            var e = t.cart,
                n = t.cartOpen,
                r = t.quickShopProduct;
            n ? h(e, r) : f()
        })), R("cart:updated", (function(e) {
            var n = e.cartOpen,
                r = e.cart;
            t.classList.remove("has-quick-shop-product"), n ? d(r) : (H({
                cartOpen: !0
            }), h(r))
    ...
    je = function(t) {
        var e = bt(t, {
            ...
            n = Wt(Ie, t),
            r = null,
            i = [Jt(Wt(De, t), "click", (function(t) {
                t.preventDefault(), c()
            })), Jt(t, "keydown", (function(t) {
                27 === t.keyCode && c()
            })), R("drawerOverlay:hiding", (function() {
                return c(!1)
            })), R("modal:open", (function(t, e) {
            ...
            a = function() {
                var t = n.querySelector(Ne);
                t && (r = C(t))
            },
            s = function() {
                Xt(t, Pe), e.activate(), B("drawerOverlay:show")
            },
            c = function() {
                var r = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
                n.innerHTML = "", e.deactivate(), r && B("drawerOverlay:hide"), Zt(t, Pe)
            };
        return {
            unload: function() {
    ...
    Me = "is-visible",
    Re = "[data-store-availability-close]",
    Be = "[data-store-availability-product]",
    He = "[data-store-list-container]",
    ze = function(t) {
        var e = bt(t, {
                allowOutsideClick: !0
            }),
            ...
            c = function(t) {
                return Tt(t.replace("." + xt(t), ""), "200x")
            },
            u = function() {
                Xt(t, Me), e.activate(), B("drawerOverlay:show")
            },
            l = function() {
                var n = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
                e.deactivate(), n && B("drawerOverlay:hide"), Zt(t, Me)
            };
        return {
            unload: function() {
                i.forEach((function(t) {
    ...
    Fe = (n(30), n(31), n(32), n(33), n(34), n(3), n(35), ".selectors-form"),
    Ue = "[data-disclosure-list]",
    Ve = "[data-disclosure-toggle]",
    We = "[data-disclosure-input]",
    Ge = "[data-disclosure-option]",
    $e = "disclosure-list--visible";
...
var Je = function(t, e) {
        var n = e.querySelector(Fe),
            r = t.querySelector(Ue),
            i = t.querySelector(Ve),
            o = t.querySelector(We),
            a = t.querySelectorAll(Ge);
        ...
        function c(e) {
            0 === Ye([t], e.relatedTarget).length && f()
        }

        function u(e) {
            var n = Ye([t], e.relatedTarget).length > 0;
            r.classList.contains($e) && !n && f()
        }
        ...
        function d(t) {
            ...
            var e = r.classList.contains($e);
            t.currentTarget.setAttribute("aria-expanded", e), e && B("navitem:closeOthers")
        }

        function h(e) {
            var n = Ye([t], e.target).length > 0;
            r.classList.contains($e) && !n && f()
        }

        function f() {
            i.setAttribute("aria-expanded", !1), r.classList.remove($e)
        }
...
fe("footer", {
    ...
    onLoad: function() {
        var t = this,
            e = this.container.querySelectorAll(Ke);
        e && e.forEach((function(e) {
            var n = e.dataset.disclosure;
            t.crossBorder[n] = Je(e, t.container)
        }))
    },
    onUnload: function() {
        var t = this;
...
var Xe = "nav__menu--active",
    Ze = "[data-navmenu-trigger]",
    Qe = "[data-nav-submenu]",
    tn = ".header__nav",
    en = ".nav__link",
    nn = ".nav__link-parent",
    rn = ".nav__item-parent",
    on = ".nav--depth-1",
    an = ".quick-search__trigger",
    sn = ".header__icon--account",
    cn = ".header__logo-image",
    un = function(t) {
        var e = t.querySelector(".header"),
            n = e.classList.contains("header--detect-menu-length"),
            r = null,
            i = t.querySelector(tn).querySelector(on),
            o = i.querySelectorAll("".concat(on, " > li:not(").concat(rn, ") > ").concat(en)),
            a = t.querySelector(cn),
            s = t.querySelector(an),
            c = t.querySelector("".concat(sn, " > a")),
            u = t.querySelectorAll("".concat(Ze, " > ").concat(nn)),
            l = [],
            d = function(t, e, n) {
            ...
            h = function(t) {
                z().headerOverlayOpen && (t.target.matches("[data-navigation-dropdown-trigger], [data-navigation-dropdown-trigger] *") || t.target.matches("[data-navigation-dropdown], [data-navigation-dropdown] *") || (m(), b()))
            },
            f = function(t) {
                t.preventDefault();
                var e = t.currentTarget.parentNode,
                    n = e.querySelector(Qe);
                g(n) ? y(e) : (B("headerOverlay:show"), v(e))
            },
            p = function(t) {
                t.preventDefault()
            },
            m = function() {
                B("headerOverlay:hide")
            },
            g = function(t) {
                return !!(t.offsetWidth || t.offsetHeight || t.getClientRects().length)
            },
            v = function(t) {
                t.parentNode.classList.contains("nav--depth-2") ? t.parentNode.querySelectorAll(Ze).forEach((function(t) {
                    return y(t)
                })) : b();
                var e = t.querySelector(Qe),
                    n = t.querySelector(en);
                e.classList.add("visible"), n.classList.add(Xe), n.setAttribute("aria-expanded", !0)
            },
            y = function(t) {
                var e = t.querySelector(Qe),
                    n = t.querySelector(en);
                t.parentNode.classList.contains("nav--depth-2") || m(), e.classList.remove("visible"), n.classList.remove(Xe), n.setAttribute("aria-expanded", !1)
            },
            b = function() {
                t.classList.remove(), t.querySelectorAll(Ze).forEach((function(t) {
                    var e = t.querySelector(Qe),
                        n = t.querySelector(en);
                    e.classList.remove("visible"), n.classList.remove(Xe), n.setAttribute("aria-expanded", !1)
                }))
            },
            w = function() {
                var t = i.scrollLeft;
...
yn.prototype.on = function(t, e) {
    var n = this.events[t];
    n || (n = new bn(t), this.events[t] = n), n.registerCallback(e)
}, yn.prototype.off = function(t, e) {
    var n = this.events[t];
    n && n.callbacks.indexOf(e) > -1 && (n.unregisterCallback(e), 0 === n.callbacks.length && delete this.events[t])
}, yn.prototype.dispatch = function(t, e) {
    var n = this.events[t];
    n && n.fire(e)
}, bn.prototype.registerCallback = function(t) {
    this.callbacks.push(t)
}, bn.prototype.unregisterCallback = function(t) {
    var e = this.callbacks.indexOf(t);
    e > -1 && this.callbacks.splice(e, 1)
}, bn.prototype.fire = function(t) {
...
var En, Sn, An, Ln = (En = function(t, e, n, r) {
    var i = new XMLHttpRequest;
    i.onreadystatechange = function() {
        if (i.readyState !== XMLHttpRequest.DONE);
        else {
            var t = i.getResponseHeader("Content-Type");
            if (i.status >= 500) return void r(new hn);
            if (404 === i.status) return void r(new dn(i.status));
            if ("string" != typeof t || null === t.toLowerCase().match("application/json")) return void r(new fn(i.status));
            if (417 === i.status) {
                try {
                    var o = JSON.parse(i.responseText);
                    r(new gn(i.status, o.message, o.description))
                } catch (t) {
                    r(new pn(i.status))
                }
                return
            ...
            if (422 === i.status) {
                try {
                    ...
                    r(new vn(i.status, a.message, a.description))
                } catch (t) {
                    r(new pn(i.status))
                }
                return
            ...
            if (429 === i.status) {
                try {
                    ...
                    r(new mn(i.status, s.message, s.description, i.getResponseHeader("Retry-After")))
                } catch (t) {
                    r(new pn(i.status))
                }
                return
            ...
            try {
                ...
                r(new ln(i.status, u.message, u.description))
            } catch (t) {
                r(new pn(i.status))
            }
        }
    }, i.open("get", "/search/suggest.json?q=" + encodeURIComponent(e) + "&" + t), i.setRequestHeader("Content-Type", "application/json"), i.send()
}, Sn = 10, An = null, function() {
    var t = this,
        e = arguments;
    clearTimeout(An), An = setTimeout((function() {
        An = null, En.apply(t, e)
    }), Sn || 0)
});

function kn(t) {
    if (!t) throw new TypeError("No config object was specified");
    this._retryAfter = null, this._currentQuery = null, this.dispatcher = new yn, this.cache = new wn({
        bucketSize: 40
    }), this.configParams = _n(t)
}
...
kn.TYPES = {
    ...
    VENDOR: "vendor"
}, kn.UNAVAILABLE_PRODUCTS = {
    SHOW: "show",
    HIDE: "hide",
    LAST: "last"
}, kn.prototype.query = function(t) {
    try {
        ! function(t) {
            var e;
    ...
    if ("" === t) return this;
    this._currentQuery = xn(t);
    var e = this.cache.get(this._currentQuery);
    return e ? (this.dispatcher.dispatch("success", e), this) : (Ln(this.configParams, t, function(t) {
        this.cache.set(xn(t.query), t), xn(t.query) === this._currentQuery && (this._retryAfter = null, this.dispatcher.dispatch("success", t))
    }.bind(this), function(t) {
        t.retryAfter && (this._retryAfter = t.retryAfter), this.dispatcher.dispatch("error", t)
    }.bind(this)), this)
}, kn.prototype.on = function(t, e) {
...
var Tn = n(19),
    ...
    Dn = function(t) {
        var e = t.opts,
            ...
            p = new kn({
                resources: {
                    type: [i && kn.TYPES.ARTICLE, o && kn.TYPES.PAGE, a && kn.TYPES.PRODUCT].filter(Boolean),
                    limit: r,
                    options: {
                        unavailable_products: "last",
                        fields: [kn.FIELDS.TITLE, kn.FIELDS.PRODUCT_TYPE, kn.FIELDS.VARIANTS_TITLE]
                    }
                }
            });
        ...
        function g(t) {
            var e = t.url,
                ...
                u = n ? '<img class="image__img lazyload" data-src="'.concat(Object(Tn.getSizedImageUrl)(n, "120x"), '" />') : '\n  <svg xmlns="http://www.w3.org/2000/svg">\n    <rect width="100%" height="100%" fill="transparent"/>\n    <svg\n      fill="none"\n      xmlns="http://www.w3.org/2000/svg"\n      preserveAspectRatio="none"\n    >\n      <text id="ok_text"\n        x="50%"\n        y="50%"\n        text-anchor="middle"\n        alignment-baseline="middle"\n        fill="currentColor"\n      >\n        Abc\n      </text>\n    </svg>\n  </svg>\n';
        ...
        return f("search", (function(t, e) {
            ...
            var r = function(t, e) {
                ...
                var o = "";
                i && (o += m(i, Cn.search.headings.products, (function(t) {
                    var e = t.url,
                        n = t.image,
                        r = t.title,
                        i = t.price,
                        o = t.vendor,
                        a = At(i * Shopify.currency.rate * 100);
                    return g({
                        url: e,
                        image: n,
                        heading: r,
                        subheading: [c && o, s && On()(a)].filter(Boolean).join(" • ")
                    })
                })));
                r && (o += m(r, Cn.search.headings.pages, (function(t) {
                    var e = t.url,
                        n = t.image,
                        r = t.title,
                        i = t.body;
                ...
                n && (o += m(n, Cn.search.headings.articles, (function(t) {
                    var e = t.url,
                        n = t.image,
                        r = t.title,
                        i = t.body;
    ...
    In = ".quick-search__trigger",
    Nn = ".search__overlay",
    jn = ".search__input",
    Mn = ".search__input-clear",
    Rn = ".search__input-close",
    Bn = ".search__results",
    Hn = "[data-settings]",
    zn = "is-active",
    Fn = "has-active-query",
    ...
    Vn = function(t) {
        var e = t.container,
            n = e.querySelector(Hn),
            r = e.querySelector(In),
            i = e.querySelector(Nn),
            o = e.querySelector(jn),
            a = e.querySelector(Mn),
            s = e.querySelector(Rn),
            c = e.querySelector(Bn),
            u = [],
        ...
        d.on("success", (function(t) {
            var n = t.markup;
            e.classList.add(Un), c.innerHTML = n
        }));
        var h = function(t, e, n) {
            ...
            f = function(t) {
                t.preventDefault(), e.classList.remove(zn)
            },
            p = function(t) {
                e.classList.contains(zn) && 27 === t.keyCode && f(t)
            },
            m = function(t) {
            ...
            g = function(t) {
                ...
                if (!n) return e.classList.remove(Fn), void e.classList.remove(Un);
                e.classList.add(Fn), (l.show_products || l.show_pages || l.show_articles) && d.query(n)
            };
        return h(r, "click", (function(t) {
            t.preventDefault(), e.classList.add(zn), o.focus()
...
var Zn = {
    ...
    obj: function(t) {
        return Kn(Object.prototype.toString.call(t), "Object")
    },
    pth: function(t) {
        return Zn.obj(t) && t.hasOwnProperty("totalLength")
    },
    svg: function(t) {
    ...
    col: function(t) {
        return Zn.hex(t) || Zn.rgb(t) || Zn.hsl(t)
    },
    key: function(t) {
        return !Wn.hasOwnProperty(t) && !Gn.hasOwnProperty(t) && "targets" !== t && "keyframes" !== t
    }
};
...
function tr(t, e) {
    var n = Qn(t),
        r = Jn(Zn.und(n[0]) ? 1 : n[0], .1, 100),
        i = Jn(Zn.und(n[1]) ? 100 : n[1], .1, 100),
        o = Jn(Zn.und(n[2]) ? 10 : n[2], .1, 100),
        a = Jn(Zn.und(n[3]) ? 0 : n[3], .1, 100),
        s = Math.sqrt(i / r),
        c = o / (2 * Math.sqrt(i * r)),
...
function er(t) {
    return void 0 === t && (t = 10),
        function(e) {
            return Math.ceil(Jn(e, 1e-6, 1) * t) * (1 / t)
        }
}
var nr, rr, ir = function() {
        function t(t, e) {
            return 1 - 3 * e + 3 * t
        }
    ...
    or = (nr = {
        ...
        var e = rr[t];
        nr["easeIn" + t] = e, nr["easeOut" + t] = function(t, n) {
            return function(r) {
                return 1 - e(t, n)(1 - r)
            }
        }, nr["easeInOut" + t] = function(t, n) {
            return function(r) {
...
function ur(t) {
    return t.reduce((function(t, e) {
        return t.concat(Zn.arr(e) ? ur(e) : e)
    }), [])
}

function lr(t) {
    return Zn.arr(t) ? t : (Zn.str(t) && (t = sr(t) || t), t instanceof NodeList || t instanceof HTMLCollection ? [].slice.call(t) : [t])
}
...
function pr(t, e) {
    var n = hr(t);
    for (var r in e) n[r] = Zn.und(t[r]) ? e[r] : t[r];
    return n
}

function mr(t) {
    return Zn.rgb(t) ? (n = /rgb\((\d+,\s*[\d]+,\s*[\d]+)\)/g.exec(e = t)) ? "rgba(" + n[1] + ",1)" : e : Zn.hex(t) ? function(t) {
        var e = t.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i, (function(t, e, n, r) {
                return e + e + n + n + r + r
            })),
            n = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e);
        return "rgba(" + parseInt(n[1], 16) + "," + parseInt(n[2], 16) + "," + parseInt(n[3], 16) + ",1)"
    }(t) : Zn.hsl(t) ? function(t) {
...
function vr(t, e) {
    return Zn.fnc(t) ? t(e.target, e.id, e.total) : t
}
...
function br(t, e, n) {
    if (dr([n, "deg", "rad", "turn"], gr(e))) return e;
    var r = Yn.CSS[e + n];
    if (!Zn.und(r)) return r;
...
function _r(t, e) {
    return Zn.dom(t) && !Zn.inp(t) && (yr(t, e) || Zn.svg(t) && t[e]) ? "attribute" : Zn.dom(t) && dr($n, e) ? "transform" : Zn.dom(t) && "transform" !== e && wr(t, e) ? "css" : null != t[e] ? "object" : void 0
}
...
function Sr(t, e, n, r) {
    var i = Kn(e, "scale") ? 1 : 0 + function(t) {
            return Kn(t, "translate") || "perspective" === t ? "px" : Kn(t, "rotate") || Kn(t, "skew") ? "deg" : void 0
        }(e),
        o = Er(t).get(e) || i;
    return n && (n.transforms.list.set(e, o), n.transforms.last = e), r ? br(t, o, r) : o
}
...
function qr(t) {
    ...
    switch (t.tagName.toLowerCase()) {
        case "circle":
            return function(t) {
                return 2 * Math.PI * yr(t, "r")
            }(t);
        case "rect":
            return function(t) {
                return 2 * yr(t, "width") + 2 * yr(t, "height")
            }(t);
        case "line":
            return function(t) {
                return xr({
        ...
        case "polygon":
            return function(t) {
                var e = t.points;
                return Tr(t) + xr(e.getItem(e.numberOfItems - 1), e.getItem(0))
            }(t)
    }
}
...
function Or(t, e) {
    var n = e || {},
        r = n.el || function(t) {
            for (var e = t.parentNode; Zn.svg(e) && Zn.svg(e.parentNode);) e = e.parentNode;
            return e
        }(t),
...
function Pr(t, e) {
    var n = /[+-]?\d*\.?\d+(?:\.\d+)?(?:[eE][+-]?\d+)?/g,
        r = kr(Zn.pth(t) ? t.totalLength : t, e) + "";
    return {
        original: r,
        numbers: r.match(n) ? r.match(n).map(Number) : [0],
        strings: Zn.str(t) || e ? r.split(n) : []
    }
}

function Dr(t) {
    return cr(t ? ur(Zn.arr(t) ? t.map(lr) : lr(t)) : [], (function(t, e, n) {
...
function Nr(t, e) {
    var n = hr(e);
    if (/^spring/.test(n.easing) && (n.duration = tr(n.easing)), Zn.arr(t)) {
        var r = t.length;
        2 === r && !Zn.obj(t[0]) ? t = {
            value: t
        } : Zn.fnc(e.duration) || (n.duration = e.duration / r)
    }
    var i = Zn.arr(t) ? t : [t];
    return i.map((function(t, n) {
        var r = Zn.obj(t) && !Zn.pth(t) ? t : {
            value: t
        };
        return Zn.und(r.delay) && (r.delay = n ? 0 : e.delay), Zn.und(r.endDelay) && (r.endDelay = n === i.length - 1 ? e.endDelay : 0), r
    })).map((function(t) {
        return pr(t, n)
    }))
}
...
function jr(t, e) {
    var n = [],
        r = e.keyframes;
    for (var i in r && (e = pr(function(t) {
            for (var e = cr(ur(t.map((function(t) {
                    ...
                    n[i] = t.map((function(t) {
                        var e = {};
                        for (var n in t) Zn.key(n) ? n == i && (e.value = t[n]) : e[n] = t[n];
                        return e
                    }))
                }, i = 0; i < e.length; i++) r(i);
            return n
        }(r), e)), e) Zn.key(i) && n.push({
        name: i,
        tweens: Nr(e[i], t)
    });
    return n
...
function Mr(t, e) {
    ...
    return t.tweens.map((function(r) {
        var i = function(t, e) {
            ...
            a = Zn.arr(o) ? o[1] : o,
            s = gr(a),
            c = Ar(e.target, t.name, s, e),
            u = n ? n.to.original : c,
            l = Zn.arr(o) ? o[0] : u,
            d = gr(l) || gr(c),
            h = s || d;
        return Zn.und(a) && (a = u), i.from = Pr(l, h), i.to = Pr(Lr(a, l), h), i.start = n ? n.end : 0, i.end = i.start + i.delay + i.duration + i.endDelay, i.easing = ar(i.easing, i.duration), i.isPath = Zn.pth(o), i.isColor = Zn.col(i.from.original), i.isColor && (i.round = 1), n = i, i
    }))
}
var Rr = {
    css: function(t, e, n) {
    ...
    Ir(t).forEach((function(t) {
        for (var n in e) {
            var r = vr(e[n], t),
                ...
                s = Lr(kr(r, o || gr(a)), a),
                c = _r(i, n);
            Rr[c](i, n, s, t.transforms, !0)
        }
    }))
}

function Hr(t, e) {
    return cr(ur(t.map((function(t) {
        return e.map((function(e) {
            return function(t, e) {
                var n = _r(t.target, e.name);
                if (n) {
                    var r = Mr(e, t),
                        i = r[r.length - 1];
                    return {
        ...
        function e(e) {
            ...
            if (n) {
                for (var r = 0; r < n;) {
                    ...
                    if (i.paused) {
                        var o = Vr.indexOf(i);
                        o > -1 && (Vr.splice(o, 1), n = Vr.length)
                    } else i.tick(e);
                    r++
                }
                t()
            } else Ur = cancelAnimationFrame(Ur)
        }
        return t
    }();
...
function $r(t) {
    ...
    function d() {
        n = 0, r = l(c.currentTime) * (1 / $r.speed)
    }
    ...
    function f(t) {
        for (var e = 0, n = c.animations, r = n.length; e < r;) {
            ...
            for (var l = Jn(t - u.start - u.delay, 0, u.duration) / u.duration, d = isNaN(l) ? 1 : u.easing(l), h = u.to.strings, f = u.round, p = [], m = u.to.numbers.length, g = void 0, v = 0; v < m; v++) {
                var y = void 0,
                    b = u.to.numbers[v],
                    w = u.from.numbers[v] || 0;
                y = u.isPath ? Cr(u.value, d * b) : w + d * (b - w), f && (u.isColor && v > 2 || (y = Math.round(y * f) / f)), p.push(y)
            }
            var _ = h.length;
            if (_) {
                g = h[0];
            ...
            Rr[i.type](o.target, i.property, g, o.transforms), i.currentValue = g, e++
        }
    }
    ...
    function m(t) {
        var d = c.duration,
            ...
            g = d - c.endDelay,
            v = l(t);
        c.progress = Jn(v / d * 100, 0, 100), c.reversePlayback = v < c.currentTime, e && function(t) {
            if (c.reversePlayback)
                for (var n = o; n--;) h(t, e[n]);
            else
                for (var r = 0; r < o; r++) h(t, e[r])
        }(v), !c.began && c.currentTime > 0 && (c.began = !0, p("begin")), !c.loopBegan && c.currentTime > 0 && (c.loopBegan = !0, p("loopBegin")), v <= m && 0 !== c.currentTime && f(0), (v >= g && c.currentTime !== d || !d) && f(d), v > m && v < g ? (c.changeBegan || (c.changeBegan = !0, c.changeCompleted = !1, p("changeBegin")), p("change"), f(v)) : c.changeBegan && (c.changeCompleted = !0, c.changeBegan = !1, p("changeComplete")), c.currentTime = Jn(v, 0, d), c.began && p("update"), t >= d && (r = 0, c.remaining && !0 !== c.remaining && c.remaining--, c.remaining ? (n = i, p("loopComplete"), c.loopBegan = !1, "alternate" === c.direction && u()) : (c.paused = !0, c.completed || (c.completed = !0, p("loopComplete"), p("complete"), !c.passThrough && "Promise" in window && (a(), s(c)))))
    }
    return c.reset = function() {
        ...
        i = t, n || (n = i), m((i + (r - n)) * $r.speed)
    }, c.seek = function(t) {
        m(l(t))
    }, c.pause = function() {
        c.paused = !0, d()
    }, c.play = function() {
        c.paused && (c.completed && c.reset(), c.paused = !1, Vr.push(c), d(), Ur || Gr())
    }, c.reverse = function() {
...
function Yr(t, e) {
    for (var n = e.length; n--;) dr(t, e[n].animatable.target) && e.splice(n, 1)
}
"undefined" != typeof document && document.addEventListener("visibilitychange", (function() {
    document.hidden ? (Vr.forEach((function(t) {
        return t.pause()
    })), Wr = Vr.slice(0), $r.running = Vr = []) : Wr.forEach((function(t) {
        return t.play()
    }))
})), $r.version = "3.2.0", $r.speed = 1, $r.running = Vr, $r.remove = function(t) {
    for (var e = Dr(t), n = Vr.length; n--;) {
        var r = Vr[n],
            i = r.animations,
            o = r.children;
        Yr(e, i);
        for (var a = o.length; a--;) {
            var s = o[a],
                c = s.animations;
            Yr(e, c), c.length || s.children.length || o.splice(a, 1)
        }
        i.length || o.length || r.pause()
    }
}, $r.get = Ar, $r.set = Br, $r.convertPx = br, $r.path = function(t, e) {
    var n = Zn.str(t) ? sr(t)[0] : t,
        r = e || 100;
    return function(t) {
        return {
            property: t,
            el: n,
            svg: Or(n),
            totalLength: qr(n) * (r / 100)
        }
    }
}, $r.setDashoffset = function(t) {
    var e = qr(t);
    return t.setAttribute("stroke-dasharray", e), e
}, $r.stagger = function(t, e) {
    void 0 === e && (e = {});
    var n = e.direction || "normal",
        r = e.easing ? ar(e.easing) : null,
        i = e.grid,
        o = e.axis,
        a = e.from || 0,
        s = "first" === a,
    ...
    return e.duration = 0, e.add = function(n, r) {
        ...
        var u = e.duration;
        c.autoplay = !1, c.direction = e.direction, c.timelineOffset = Zn.und(r) ? u : Lr(r, u), a(e), e.seek(c.timelineOffset);
        var l = $r(c);
        a(l), o.push(l);
        var d = zr(o, t);
        return e.delay = d.delay, e.endDelay = d.endDelay, e.duration = d.duration, e.seek(0), e.reset(), e.autoplay && e.play(), e
    }, e
}, $r.easing = ar, $r.penner = or, $r.random = function(t, e) {
...
var Qr = "undefined" != typeof window && window.navigator && window.navigator.platform && (/iP(ad|hone|od)/.test(window.navigator.platform) || "MacIntel" === window.navigator.platform && window.navigator.maxTouchPoints > 1),
    ti = [],
    ei = !1,
    ni = -1,
    ri = void 0,
    ...
    ai = function(t) {
        ...
        return !!oi(e.target) || (e.touches.length > 1 || (e.preventDefault && e.preventDefault(), !1))
    },
    si = function() {
        setTimeout((function() {
            void 0 !== ii && (document.body.style.paddingRight = ii, ii = void 0), void 0 !== ri && (document.body.style.overflow = ri, ri = void 0)
        }))
    },
    ci = function(t, e) {
        if (Qr) {
            ...
            if (t && !ti.some((function(e) {
                ...
                ti = [].concat(Kr(ti), [n]), t.ontouchstart = function(t) {
                    1 === t.targetTouches.length && (ni = t.targetTouches[0].clientY)
                }, t.ontouchmove = function(e) {
                    1 === e.targetTouches.length && function(t, e) {
                        var n = t.targetTouches[0].clientY - ni;
                        !oi(t.target) && (e && 0 === e.scrollTop && n > 0 || function(t) {
                            return !!t && t.scrollHeight - t.scrollTop <= t.clientHeight
                        }(e) && n < 0 ? ai(t) : t.stopPropagation())
                    }(e, t)
                }, ei || (document.addEventListener("touchmove", ai, Xr ? {
                    passive: !1
                } : void 0), ei = !0)
            }
        } else {
            ! function(t) {
                setTimeout((function() {
                    if (void 0 === ii) {
                        ...
                        e && n > 0 && (ii = document.body.style.paddingRight, document.body.style.paddingRight = n + "px")
                    }
                    void 0 === ri && (ri = document.body.style.overflow, document.body.style.overflow = "hidden")
                }))
            }(e);
            var r = {
                targetElement: t,
    ...
    ui = function(t) {
        if (Qr) {
            ...
            t.ontouchstart = null, t.ontouchmove = null, ti = ti.filter((function(e) {
                return e.targetElement !== t
            })), ei && 0 === ti.length && (document.removeEventListener("touchmove", ai, Xr ? {
                passive: !1
            } : void 0), ei = !1)
        } else(ti = ti.filter((function(e) {
            return e.targetElement !== t
        }))).length || si()
    },
    li = n(20),
...
var fi = "active",
    ...
    mi = function(t) {
        ...
        function u(t) {
            "" === t.target.value && i.classList.remove(pi), (s.show_products || s.show_pages || s.show_articles) && c.query(t.target.value)
        }
        ...
        function d(e) {
            e && e.preventDefault(), t.classList.remove(pi), setTimeout((function() {
                t.classList.remove(fi), ui(t), a()
            }), 350)
        }
        return c.on("success", (function(t) {
            var e = t.markup;
            i.classList.add(pi), i.innerHTML = e
        })), {
            open: function() {
                t.classList.add(fi), setTimeout((function() {
                    a = function(t) {
                        if (t) {
                    ...
                    }(e), ci(t), t.classList.add(pi), n.focus()
                }), 50)
            },
            close: d,
            destroy: function() {
    ...
    bi = "[data-all-links]",
    wi = "[data-main]",
    _i = "[data-primary-container]",
    Ei = "[data-footer]",
    Si = "[data-close-drawer]",
    Ai = ".drawer-menu__form",
    Li = "[data-locale-input]",
    ki = "[data-currency-input]",
    xi = "[data-quick-search]",
    Ti = "active",
    qi = "visible",
    Oi = function(t) {
        return Jr({
    ...
    Pi = function(t) {
        var e = 0,
            ...
            i = t.querySelector(gi);
        i.addEventListener("click", y);
        var o = t.querySelector(xi),
            a = mi(o),
            s = t.querySelector("[data-search]");
        s.addEventListener("click", g);
        var c = t.querySelector(bi),
            u = t.querySelector(wi),
            l = t.querySelector(_i),
            d = t.querySelector(Ai),
            h = t.querySelector(Li),
            f = t.querySelector(ki),
            p = t.querySelector(Si);
        p.addEventListener("click", y);
        var m = t.querySelectorAll(yi);
            ...
            switch (t.preventDefault(), t.currentTarget.dataset.item) {
                ...
                case "parent":
                    ! function(t) {
                        ...
                        e.classList.add(qi), u.style.height = Ci(e.offsetHeight);
                        var r = e.querySelectorAll(":scope > ".concat(vi));
                        Oi(r), b(n += 1)
                    }(t);
                    break;
                case "back":
                    ! function(t) {
                        t.preventDefault();
                        var e = t.currentTarget.closest(vi).closest("ul");
                        u.style.height = Ci(e.offsetHeight), t.currentTarget.closest("ul").classList.remove(qi), b(n -= 1)
                    }(t);
                    break;
                case "secondary":
                    ! function(t) {
                        ...
                        var e = t.currentTarget.nextElementSibling;
                        e.classList.add(qi);
                        var n = e.querySelectorAll(":scope > ".concat(vi));
                        Oi(n)
                    }(t);
                    break;
                case "secondaryHeading":
                    ! function(t) {
                        t.preventDefault(), w(0), t.currentTarget.closest("ul").classList.remove(qi)
                    }(t);
                    break;
                case "locale":
                    S(t);
        ...
        function y(e) {
            e && e.preventDefault(), r.deactivate(), t.classList.remove(qi), setTimeout((function() {
                t.classList.remove(Ti), ui(t)
            }), 350)
        }
        ...
        function E(e) {
            t.classList.contains(qi) && ("Escape" == e.key || 27 === e.keyCode && drawerOpen) && y()
        }
        ...
        return window.addEventListener("keydown", E), {
            ...
            destroy: function() {
                ...
                })), ui(t), window.removeEventListener("keydown", E)
            },
            open: function() {
                t.classList.add(Ti), setTimeout((function() {
                    r.activate(), t.classList.add(qi), ci(t, {
                    ...
                    var i = t.querySelectorAll("".concat(_i, " > ").concat(vi, ", ").concat(Ei, " > li, ").concat(Ei, " > form > li"));
                    0 === e && 0 === n && (u.style.height = Ci(l.offsetHeight), Oi(i))
                }), 50)
            }
        }
    },
    Di = ".js-cart-count",
    Ii = ".js-cart-drawer-toggle",
    Ni = ".quick-cart__indicator-inner",
    ji = ".header__icon--currency",
    Mi = ".header__icon--language",
    Ri = "[data-disclosure]",
    Bi = "[data-drawer-menu]";
fe("header", {
    crossBorder: {},
    onLoad: function() {
        var t = this,
            e = document.querySelector(Bi);
        this.menu = Pi(e), this.menuButton = this.container.querySelector("#mobile-nav");
        var n = this.container.querySelector(Di),
            r = this.container.querySelectorAll(Ii);
        this.navigation = un(this.container), this.navigationCloseHandler = R("navitem:closeOthers", (function() {
            t.navigation.closeAll()
        })), this.menuButton.addEventListener("click", this._openMenu.bind(this)), R("cart:updated", (function(t) {
            var e = n.querySelector(Ni);
        ...
        for (var i = 0; i < r.length; i++) r[i].addEventListener("click", (function(t) {
            t.preventDefault(), B("cart:toggle", (function(t) {
                return {
                    cartOpen: !t.cartOpen
                }
            }))
        }));
        this.quickSearch = this.container.querySelector(".quick-search"), this.predictiveSearch = Vn({
    ...
    _showHeaderOverlay: function(t) {
        "true" === t.target.ariaExpanded ? B("headerOverlay:show") : B("headerOverlay:hide")
    },
    _initDisclosure: function() {
        var t = this.container.querySelector(Mi),
            e = this.container.querySelector(ji);
        if (t) {
            this.languageTrigger = t.querySelector(Ri);
            var n = this.languageTrigger.dataset.disclosure;
            this.crossBorder[n] = Je(this.languageTrigger, t), this.languageTrigger.addEventListener("click", this._showHeaderOverlay)
        }
        if (e) {
            this.currencyTrigger = e.querySelector(Ri);
            var r = this.currencyTrigger.dataset.disclosure;
            this.crossBorder[r] = Je(this.currencyTrigger, e), this.currencyTrigger.addEventListener("click", this._showHeaderOverlay)
        }
    },
    onSelect: function() {
        B("sticky-header:reload", (function() {}))
    },
    ...
    Ki = function(t) {
        ...
        return {
            ...
            unobserve: function(t) {
                Ji()("observables"), e = e.filter((function(e) {
                    return e.el !== t
                }))
            }
        }
...
var Qi = {
    ...
    to = ".announcement-bar",
    eo = "is-active",
    no = "--announcement-height";
fe("announcement-bar", {
    onLoad: function() {
        this.announcements = this.container.querySelectorAll(to);
        var t = this.container.dataset.timing;
        Qi.autoPlay = parseInt(t), this._init(), this._setAnnouncementVars()
    },
    _init: function() {
        var t = this;
        this.slideshow = new $i.a(this.container, Zi(Zi({}, Qi), {}, {
            on: {
                ready: function() {
                ...
                change: function(e) {
                    t.announcements.forEach((function(t, n) {
                        t.classList.toggle(eo, n === e)
                    }))
                }
            }
        })), this.resizeObserver = Ki((function() {
            B("sticky-header:reload", (function() {})), t._setRootVar(no, t.container.offsetHeight)
    ...
    _setAnnouncementVars: function() {
        this._setRootVar(no, this.announcements.length ? this.container.offsetHeight : 0)
    },
    onSelect: function() {
        B("sticky-header:reload", (function() {})), this._setAnnouncementVars()
    },
    onBlockSelect: function(t) {
        var e = t.target;
...
var so = Wi()({
    ...
    co = function(t) {
        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
            ...
            s = o.textAlignment,
            c = "middle" === a,
            u = t.classList.contains(so.carouselWraps),
            l = t.querySelector(so.previousButton),
            d = t.querySelector(so.nextButton),
            h = t.querySelector(so.carousel),
            f = t.querySelectorAll(so.slides),
            p = t.querySelector(so.textBlock),
            m = function() {
                var t = {
                    adaptiveHeight: !1,
                    wrapAround: !1,
                ...
                u ? t.wrapAround = !0 : u || "right" != s || (t.initialIndex = f.length - 1, t.cellAlign = "right"), i = new $i.a(h, ao(ao({}, t), {}, {
                    on: {
                        ready: function() {
                            y()
                        },
...
fe("blog-posts", {
    onLoad: function() {
        this.animatedSlides = this.container.querySelectorAll(lo.animatedSlides), this.carouselContainer = this.container.querySelector(lo.carouselContainer), this.animatedSlides.length > 1 && (this.carousel = co(this.container)), this.animatedSlides.length && (this.scrollAnimation = uo(this.container, this.animatedSlides))
    },
    onUnload: function() {
        this.carousel && this.carousel.unload(), this.animatedSlides.length && this.scrollAnimation.unload()
    }
}), ho.prototype.add = function(t, e, n) {
    this.entries.push({
        element: t,
        event: e,
        fn: n
    }), t.addEventListener(e, n)
}, ho.prototype.removeAll = function() {
...
function wo(t, e, n) {
    this.element = t, this.product = function(t) {
        ...
        return t
    }(e), n = n || {}, this._listeners = new ho, this._listeners.add(this.element, "submit", this._onSubmit.bind(this, n)), this.optionInputs = this._initInputs(go, n.onOptionChange), this.quantityInputs = this._initInputs(vo, n.onQuantityChange), this.propertyInputs = this._initInputs(yo, n.onPropertyChange)
}
wo.prototype.destroy = function() {
    this._listeners.removeAll()
}, wo.prototype.options = function() {
    ...
    var t, e
}, wo.prototype.variant = function() {
    return fo(this.product, this.options())
}, wo.prototype.properties = function() {
...
}, wo.prototype._getProductFormEventData = function() {
    return {
...
function xo(t, e) {
    var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
        ...
        i = [],
        o = function(t, e, n) {
            t.addEventListener(e, n, !0), i.push({
                element: t,
                action: e,
                func: n
            })
        ...
        a = function() {
            return qo(m, (function(t) {
                return t.name = /(?:^(options\[))(.*?)(?:\])/.exec(t.name)[2], t
            }))
        },
        s = function() {
            $(".product-form__chip-selected").text(r.option1);
            return console.log(r, " prod"), console.log(a(), " options"), console.log(fo(r, a()), " return variant from serialized array"), fo(r, a())
        },
        c = function() {
            var t = Oo(v, (function(t) {
                return /(?:^(properties\[))(.*?)(?:\])/.exec(t)[2]
            }));
        ...
        h = function(e) {
            var n = t.querySelector(So);
            n || (Ji()("idInputElement"), (n = document.createElement("input")).type = "hidden", n.name = "id", t.appendChild(n)), n.value = e.toString()
        },
        f = function(t) {
            t.dataset = l(), h(t.dataset.variant.id), n.onFormSubmit && n.onFormSubmit(t)
        },
        p = function(e, n) {
            return Ct()(t.querySelectorAll(e)).map((function(t) {
                return o(t, "change", d(n)), t
            }))
        };
    o(t, "submit", f);
    var m = p(Ao, n.onOptionChange),
        g = p(Lo, n.onQuantityChange),
        v = p(ko, n.onPropertyChange),
        y = function() {
            i.forEach((function(t) {
                t.element.removeEventListener(t.action, t.function)
            }))
...
function To(t) {
    if ("object" !== Eo()(t)) throw new TypeError(t + " is not an object.");
    if (void 0 === t.variants[0].options) throw new TypeError("Product object is invalid. Make sure you use the product object that is output from {{ product | json }} or from the http://[your-product-url].js route");
    return t
}
...
var Co = n(8),
    Po = n.n(Co),
    Do = "[data-store-availability-drawer-trigger]",
    Io = "[data-store-availability-list-content]",
    No = function(t, e, n) {
        var r = null,
            i = n,
            o = new Po.a(t),
            a = function(e) {
                ...
                t.innerHTML = "", fetch(n).then((function(t) {
                    ...
                    "" !== e.trim() && (t.innerHTML = e, t.innerHTML = t.firstElementChild.innerHTML, r = Wt(Io, t))
                }))
            };
        a(n), o.on("click", Do, (function(t) {
    ...
    Ro = function(t) {
            ...
            s = function(e) {
                if ("true" === i) {
                    ...
                    var n = e.dataset,
                        ...
                        a = n.properties,
                        s = n.quantity,
                        c = t.querySelector(o.addButton);
                    c.classList.add("bttn--loading"), se(r.id, s, a).then((function() {
                        c.classList.remove("bttn--loading")
                    }))
                }
            },
            c = {
        ...
        var y = function(e) {
                ...
                if (!n) return Rt(t), b(n), void(g && a && g.unload());
                var r = bo(window.location.href, n.id);
                if (window.history.replaceState({
                        path: r
                    }, "", r), b(n), t.querySelector("".concat(o.variantSelect, " ").concat(o.optionById(n.id))).selected = !0, Rt(t, n), be(p, n), l && n.featured_media)
                    if (window.matchMedia("(min-width: 60em)").matches) {
                        var i = document.querySelector('[data-media-id="'.concat(n.featured_media.id, '"]'));
                        i && i.scrollIntoView({
                            behavior: "smooth"
                        })
                    } else B("product:mediaSelect", (function() {
                        return {
            ...
            b = function(e) {
                var n = p || t,
                    ...
                    a = jo.product.unavailable;
                if (!e) return r.forEach((function(t) {
                    return t.innerHTML = a
                })), i.forEach((function(t) {
                    return t.innerHTML = ""
                })), void i.forEach((function(t) {
                    return t.classList.add(Mo)
                }));
                r.forEach((function(t) {
                    return t.innerHTML = de(e.price)
                })), e.compare_at_price > e.price ? (i.forEach((function(t) {
                    return t.innerHTML = de(e.compare_at_price)
                })), i.forEach((function(t) {
    ...
    Ho = function(t) {
        ...
        function s(t) {
            t.preventDefault();
            var e, r = n.querySelector(Bo.form),
                ...
                s = {
                    onOptionChange: function(t) {
                        return function(t) {
                            ...
                            if (!e) return Rt(n), void Ft(n, e);
                            n.querySelector("".concat(Bo.variantSelect, " ").concat(Bo.optionById(e.id))).selected = !0, e.featured_media ? Vt(n, e.featured_image.src) : Vt(n, i), Ft(n, e), Rt(n, e), be(n, e)
                        }(t)
                    }
                };
            a((function(t) {
                Ro(r, s), i = t.featured_image, B("cart:toggle", (function(t) {
                    return {
                        cartOpen: !t.cartOpen,
                        quickShopProduct: n
                    }
...
fe("collection-list", {
    onLoad: function() {
        var t = this;
        this.animatedSlides = this.container.querySelectorAll(Fo.animatedSlides), this.carouselContainer = this.container.querySelector(Fo.carouselContainer), this.carousel = co(this.container);
        var e = this.container.querySelectorAll(Fo.products);
        this.productItems = [], e.forEach((function(e) {
            t.productItems.push(Ho(e))
    ...
    _initScrollAnimation: function(t) {
        ...
        this.scrollAnimation = uo(this.container, t, e)
    },
    onBlockSelect: function(t) {
        var e = t.target;
...
var Uo = ".animates";
fe("collection-list-grid", {
    onLoad: function() {
        this.animatedItems = this.container.querySelectorAll(Uo), this.animatedItems.length && (this.scrollAnimation = uo(this.container, this.animatedItems))
    },
    onUnload: function() {
...
var Vo = ".featured-collection__slides",
    Wo = ".animates",
    Go = ".product-item";
fe("featured-collection", {
    onLoad: function() {
        var t = this;
        this.animatedSlides = this.container.querySelectorAll(Wo), this.carouselContainer = this.container.querySelector(Vo), this.carousel = co(this.container);
        var e = this.container.querySelectorAll(Go);
        this.productItems = [], e.forEach((function(e) {
            t.productItems.push(Ho(e))
        })), this.animatedSlides.length && this._initScrollAnimation(zo(this.container, this.animatedSlides))
    },
...
function Jo(t) {
        ...
        if (s && o.includes(s) && !Object.keys(c).includes(i)) {
            ...
            switch (u.type) {
                ...
                case "external_video":
                    ...
                    break;
                case "model":
                    u.viewer = new n.ModelViewerUI(Wt("model-viewer", t)), Jt(Wt(".model-poster", t), "click", (function(t) {
                        t.preventDefault(),
                            function(t) {
                                l(t), t.viewer.play(), Xt(t.container, "model-active"), a = t, setTimeout((function() {
                                    Wt("model-viewer", t.container).focus()
                                }), 300)
                            }(u)
                    }))
            }
    ...
    function l(t) {
        if (a && t != a) return a.player ? ("video" === a.type ? a.player.pause() : "external_video" === a.type && a.player.pauseVideo(), void(a = null)) : void(a.viewer && (Zt(a.container, "model-active"), a.viewer.pause(), a = null))
    }
}
fe("featured-collection-grid", {
    onLoad: function() {
        var t = this;
        this.animatedItems = this.container.querySelectorAll(Yo);
        var e = this.container.querySelectorAll($o);
        this.productItems = [], e.forEach((function(e) {
            t.productItems.push(Ho(e))
        })), this.animatedItems.length && (this.scrollAnimation = uo(this.container, this.animatedItems))
    },
    onUnload: function() {
...
var Ko = "[data-variant-popup-trigger]",
    Xo = function(t) {
        var e = new Po.a(t);
        return e.on("click", Ko, (function(e) {
            e.preventDefault();
    ...
    Zo = theme.strings.products,
    Qo = "[data-product-swatches]",
    ta = "[data-product-chips]",
    ea = ".product-form__quantity",
    na = ".share",
    ra = ".featured-product__meta-inner",
    ia = ".featured-product__description",
    oa = ".accordion",
    aa = "[data-product-form]";
fe("featured-product", {
    onLoad: function() {
        this.media = Jo(this.container);
        ...
        t && (this.productForm = Ro(t, e), this.swatches = Dt.call(this, Qo), this.chips = Nt.call(this, ta), this.quantityInput = jt.call(this, ea), this.variantPopup = Xo(this.container)), this.productDetails = this.container.querySelector(ra), this._checkForAccordions()
    },
    _checkForAccordions: function() {
        var t = this.container.querySelector(ia);
        if (t) {
            var e = t.querySelector(oa),
                n = this.container.querySelector(na);
            n && e && this._appendSharingToAccordion(n, e)
        }
    },
    _appendSharingToAccordion: function(t, e) {
        var n = t.outerHTML,
            r = Zo.product.share_heading,
...
var sa = ".image",
    ca = ".image-with-text__text-block";
fe("image-with-text", {
    animationObserver: null,
    onLoad: function() {
        this.textBlock = this.container.querySelector(ca), this.image = this.container.querySelector(sa);
        var t = this.container.dataset.animationEnabled;
        this.observerOptions = {
            root: null,
            rootMargin: "0px",
            threshold: 0
        }, this._onScroll = this._onScroll.bind(this), this._updateTextPosition = this._updateTextPosition.bind(this), this._updateImageScale = this._updateImageScale.bind(this), "true" === t && this.image && this._initAnimationObserver(), this.scrollAnimation = uo(this.container)
    },
    _initAnimationObserver: function() {
        !0 !== Shopify.designMode && (this.animationObserver = new IntersectionObserver(this._handleAnimation.bind(this), this.observerOptions), this.animationObserver.observe(this.container))
    },
    ...
    onUnload: function() {
        this.animationObserver && this.animationObserver.disconnect(), this.scrollAnimation.unload()
    }
}), fe("newsletter", {
    onLoad: function() {
        this.scrollAnimation = uo(this.container)
    },
    onUnload: function() {
...
var ua = {
    ...
    la = "product-recommendations--static",
    da = ".product-recommendations__inner",
    ha = ".product-recommendations__products",
    fa = ".product-item";
fe("product-recommendations", {
    onLoad: function() {
        this._getProductRecommendations()
    },
    _getProductRecommendations: function() {
        var t = this,
            e = this.container.querySelector(da),
            n = e.dataset,
            r = n.productId,
            i = n.limit,
            o = "".concat(window.theme.routes.productRecommendations, "?section_id=").concat(la, "&limit=").concat(i, "&product_id=").concat(r),
    ...
    _initProductItems: function() {
        var t = this,
            e = this.container.querySelectorAll(fa);
        this.productItems = [], e.forEach((function(e) {
            t.productItems.push(Ho(e))
        }))
    },
    _initSlider: function() {
        console.log("Init slideshow 2");
        var t = this.container.querySelector(ha);
        this.slider = new $i.a(t, ua), this.slider.resize()
    },
    onUnload: function() {
        this.productItems.forEach((function(t) {
            return t.unload()
...
var pa = function(t, e) {
        if (!0 !== Shopify.designMode) {
            var n = !1,
                ...
                a = new IntersectionObserver((function(t) {
                    t.forEach((function(t) {
                        t.isIntersecting ? window.addEventListener("scroll", s, {
                            capture: !0,
                            passive: !0
        ...
        function s() {
            var e, a;
            t.clientHeight, e = t.getBoundingClientRect(), a = window.pageYOffset || document.documentElement.scrollTop, r = e.top + a, (i = window.innerHeight || document.documentElement.clientHeight) > r && (n = !0, i = 0), o = window.scrollY - r + i, requestAnimationFrame(c)
        }

        function c() {
          //comment added for remove for remove zoom in teaclub new page
           // n && o > 0 ? e.style.transform = "scale(".concat(1 + 15e-5 * o, ")") : n || (e.style.transform = "scale(".concat(1 + 15e-5 * o, ")"))
          console.log("above code remove for remove zooming")
        }
    },
    ma = function(t) {
        var e = document.body;
...
var va = ".js-slideshow",
    ya = ".slideshow__slide",
    ba = ".slideshow__image",
    wa = ".slideshow__image--desktop",
    _a = ".slideshow__image--mobile",
    Ea = ".slideshow__pseudo-dots",
    Sa = ".slideshow__pseudo-dot";
...
fe("slideshow", {
    slideshow: null,
    onLoad: function() {
        this.slideshowContainer = this.container.querySelector(va), this.slides = this.container.querySelectorAll(ya), this.slideImagesDesktop = this.container.querySelectorAll(wa), this.slideImagesMobile = this.container.querySelectorAll(_a);
        var t = this.container.dataset.enableNavigationDots;
        this.showPageDots = "true" === t;
        var e = document.documentElement.style;
        this.transformProp = "string" == typeof e.transform ? "transform" : "WebkitTransform", ma(this.container) && this.container.classList.add("first-full-height"), this._initSlideshow(), zi()() || (this.observedItems = this.slides.forEach((function(t) {
            var e = t.querySelector(ba);
            return pa(t, e)
        })))
    },
    _reinitSlideshow: function() {
        this.slideshow.destroy(), this._initSlideshow()
    },
    _initSlideshow: function() {
        ...
        var t = this,
            e = {
                ...
                prevNextButtons: !1,
                adaptiveHeight: !0,
                pageDots: this.showPageDots
            },
            n = this.container.dataset.timer;
        e.autoPlay = parseInt(n), this.slides.length > 1 ? (this.slideshow = new $i.a(this.slideshowContainer, function(t) {
            for (var e = 1; e < arguments.length; e++) {
                var n = null != arguments[e] ? arguments[e] : {};
            ...
            return t
        }({}, e)), this.slideshow.on("scroll", (function() {
            t.slideshow.slides.forEach((function(e, n) {
                t._handleSlideScroll(e, n)
            }))
        })), this.showPageDots || (this._initPseudoDots(), this.slideshow.on("select", (function() {
            t._updatePseudoDots(t.slideshow.selectedIndex)
        })))) : 1 === this.slides.length && this.slides[0].classList.add("is-selected")
    },
    _handleSlideScroll: function(t, e) {
        var n;
        n = ro() ? this.slideImagesMobile[e] : this.slideImagesDesktop[e];
        var r = 0;
    ...
    _initPseudoDots: function() {
        var t = this.container.querySelector(Ea),
            e = t.querySelector(".next"),
            n = t.querySelector(".prev");
        e.addEventListener("click", this._handlePseudoDot.bind(this)), n.addEventListener("click", this._handlePseudoDot.bind(this))
    },
    _handlePseudoDot: function(t) {
        t.preventDefault(), t.target.classList.contains("is-selected") || (t.target.classList.contains("next") ? this.slideshow.next() : this.slideshow.previous())
    },
    _updatePseudoDots: function(t) {
        var e = this.container.querySelectorAll(Sa);
        e.forEach((function(t) {
            return t.classList.remove("is-selected")
        })), e[t % 2].classList.add("is-selected")
    },
    onUnload: function() {
        this.slideshow && (this.slideshow.destroy(), this.showPageDots || (nextTrigger.removeEventListener("click", this._handlePseudoDot), previousTrigger.removeEventListener("click", this._handlePseudoDot))), this.atBreakpointChange.unload()
    },
    onBlockSelect: function(t) {
        var e = t.target;
...
var La = ".slideshow-split__slideshow",
    ka = ".slideshow-split__slide",
    xa = ".image__img",
    Ta = ".slideshow-split__underlay",
    qa = ".slideshow-split__pseudo-dots",
    Oa = ".slideshow-split__pseudo-dot";
fe("slideshow-split", {
    onLoad: function() {
        this.slideshowContainer = this.container.querySelector(La), this.slides = this.container.querySelectorAll(ka);
        var t = this.container.dataset.enableNavigationDots;
        this.showPageDots = "true" === t;
        var e = this.container.querySelector(Ta);
        ma(this.container) && this.container.classList.add("first-full-height"), this.slides.length > 1 && (this._initSlideshow(), function(t, e) {
            for (var n = t.getElementsByTagName("img"), r = n.length, i = 0, o = 0; o < r; o++) n[o].onload = function() {
                ++i === r && e()
            }
        }(this.container, (function() {
            return e.classList.remove("hide")
        }))), this.scrollAnimation = uo(this.container), zi()() || (this.observedItems = this.slides.forEach((function(t) {
            t.querySelectorAll(xa).forEach((function(e) {
                pa(t, e)
            }))
        })))
    },
    _initSlideshow: function() {
        console.log("Init slideshow 1");
        var t = this,
            e = {
                percentPosition: !0,
                wrapAround: !0,
            ...
            n = this.container.dataset.timer;
        e.autoPlay = parseInt(n), this.slideshow = new $i.a(this.slideshowContainer, function(t) {
            for (var e = 1; e < arguments.length; e++) {
                var n = null != arguments[e] ? arguments[e] : {};
            ...
            return t
        }({}, e)), this.showPageDots || (this._initPseudoDots(), this.slideshow.on("select", (function() {
            t._updatePseudoDots(t.slideshow.selectedIndex)
        })))
    },
    _initPseudoDots: function() {
        var t = this.container.querySelector(qa),
            e = t.querySelector(".next"),
            n = t.querySelector(".prev");
        e.addEventListener("click", this._handlePseudoDot.bind(this)), n.addEventListener("click", this._handlePseudoDot.bind(this))
    },
    ...
    _updatePseudoDots: function(t) {
        var e = this.container.querySelectorAll(Oa);
        e.forEach((function(t) {
            return t.classList.remove("is-selected")
        })), e[t % 2].classList.add("is-selected")
    },
    onUnload: function() {
        this.slideshow && this.slideshow.destroy(), this.scrollAnimation.unload()
    },
    onBlockSelect: function(t) {
        var e = t.target;
...
var Ca = n(22),
    ...
    Ia = ".video__overlay",
    Na = ".video__player",
    ja = "[data-video-trigger]";
fe("video", {
    videoType: null,
    videoPlayer: null,
    onLoad: function() {
        this._initPlayer(), this.scrollAnimation = uo(this.container)
    },
    _initPlayer: function() {
        var t = this.container.dataset,
            ...
            n = t.videoType;
        if (e && n) {
            var r = this.container.querySelector(Ia),
                i = this.container.querySelector(Na);
            this.button = this.container.querySelector(ja), this.video = function(t, e) {
                void 0 === e && (e = {});
                var n, r = e.id,
                    i = e.playerEl,
                    o = e.type;
                if (r && o) {
                    var a = F(),
                        s = a.on,
                        c = a.emit;
                    return "youtube" === o ? ((n = Pa()(i)).loadVideoById({
                        videoId: r,
...
fe("quote", {
    onLoad: function() {
        ...
        Ma.autoPlay = parseInt(t);
        var e = this.container.querySelector(".quote__container");
        this.slideshow = new $i.a(e, Ma), this.scrollAnimation = uo(this.container)
    },
    onBlockSelect: function(t) {
        var e = t.target;
    ...
    onUnload: function() {
        this.slideshow.destroy(), this.scrollAnimation.unload()
    }
});
var Ra = ".gallery__slides",
    Ba = ".animates";
fe("gallery", {
    onLoad: function() {
        this.animatedSlides = this.container.querySelectorAll(Ba), this.carouselContainer = this.container.querySelector(Ra), this.carousel = co(this.container), this.animatedSlides.length && this._initScrollAnimation(zo(this.container, this.animatedSlides))
    },
    _initScrollAnimation: function(t) {
        var e = "top" === this.container.dataset.textPosition ? 0 : 750;
        this.scrollAnimation = uo(this.container, t, e)
...
var Ha = n(9),
    za = n.n(Ha),
    Fa = ".location__map-container",
    Ua = ".location__map-element";
fe("location", {
    onLoad: function() {
        this._initMap(), this.scrollAnimation = uo(this.container)
    },
    _initMap: function() {
        var t = this;
        this.mapContainer = this.container.querySelector(Fa);
        var e = null,
            n = null;
        if (this.mapContainer && (e = this.mapContainer.dataset.address, n = this.mapContainer.dataset.apiKey), n && e) {
            ...
            za.a.KEY = n, za.a.VERSION = "3.34", za.a.LIBRARIES = ["geocoding-api"], za.a.load((function(n) {
                (new n.maps.Geocoder).geocode({
                    ...
                    var c = new n.maps.Map(t.container.querySelector(Ua), {
                        center: s,
                        zoom: 12,
                        styles: o.styles
                    });
    ...
    onUnload: function() {
        za.a.release(), this.scrollAnimation.unload()
    }
});
var Va = ".testimonials__slides",
    Wa = ".animates";
fe("testimonials", {
    onLoad: function() {
        this.animatedSlides = this.container.querySelectorAll(Wa), this.carouselContainer = this.container.querySelector(Va), this.carousel = co(this.container), this.animatedSlides.length && this._initScrollAnimation(zo(this.container, this.animatedSlides))
    },
    _initScrollAnimation: function(t) {
        var e = "top" === this.container.dataset.textPosition ? 0 : 750;
        this.scrollAnimation = uo(this.container, t, e)
...
var Ga = ".collage__item",
    $a = ".collage__item-inner";
fe("collage", {
    observedItems: null,
    onLoad: function() {
        this.collageItems = this.container.querySelectorAll(Ga), "true" === this.container.dataset.animationEnabled && (this.observedItems = this.collageItems.forEach((function(t) {
            var e = t.querySelector($a);
            return pa(t, e)
        }))), this.scrollAnimation = uo(this.container, this.collageItems)
    },
    onUnload: function() {
...
var Ya = ".animates";
fe("text-columns-with-images", {
    animationPlayedOnLoad: !1,
    onLoad: function() {
        this.animatedItems = this.container.querySelectorAll(Ya), this.scrollAnimation = uo(this.container, this.animatedItems)
    },
    onUnload: function() {
        this.scrollAnimation.unload()
    }
...
var Ja = theme.strings.products,
    Ka = ".spr-summary-starrating",
    Xa = ".spr-summary-actions-togglereviews",
    Za = function(t) {
        var e = t.querySelector("[data-reviews-close]"),
            ...
            r = function() {
                ...
                e && B("drawerOverlay:hide"), t.classList.remove("is-visible"), setTimeout((function() {
                    n.deactivate()
                }), 50)
            };
        ...
        var i = new MutationObserver((function() {
            ...
            if (e) {
                var n = t.querySelector(Xa),
                    r = Ja.product.write_review;
                if (n) {
                    var o = n.innerText;
                    r = "".concat(o.match(/\d+/g), " ").concat(Ja.product.total_reviews)
                }
                B(Y.added, (function() {
                    return {
                        starRating: e,
        ...
        var o = R("drawerOverlay:hiding", (function() {
            return r(!1)
        }));
        ...
        return {
            ...
            open: function() {
                t.classList.add("is-visible"), B("drawerOverlay:show");
    ...
    Qa = "[data-reviews-drawer]",
    ts = ".product__reviews",
    es = ".product__reviews-stars",
    ns = ".product__reviews-trigger",
    rs = function(t) {
        var e = t.querySelectorAll(ts),
            n = t.querySelector(Qa),
            r = t.querySelectorAll(ns),
            i = Za(n),
            o = R(Y.added, (function(t) {
                var n = t.starRating,
                    r = t.totalReviews;
...
var as = theme.strings.products,
    ss = ".product-page-wrapper",
    cs = ".product__media",
    us = ".media__image",
    ls = "[data-product-swatches]",
    ds = "[data-product-chips]",
    hs = ".product-form__quantity",
    fs = ".share",
    ps = ".product__meta-inner",
    ms = ".product__description",
    gs = ".accordion",
    vs = "[data-product-form]",
    ys = ".product__media-action-button",
    bs = {
        adaptiveHeight: !1,
...
fe("product", {
    ...
    _initLightbox: function() {
        var t = this;
        this.images = this.container.querySelectorAll(us), this.lightboxTrigger = this.container.querySelector(ys);
        var e = this.container.querySelector("[data-lightbox]");
        this.lightbox = function(t) {
            var e = [Jt(Wt("[data-close]", t), "click", (function(t) {
                    t.preventDefault(), r()
                })), Jt(t, "keydown", (function(t) {
                    27 === t.keyCode && r()
                }))],
            ...
            function r() {
                Zt(t, "visible"), setTimeout((function() {
                    Zt(t, "active"), ui(), n.deactivate()
                }), 300)
            }
            return {
                destroy: function() {
                ...
                open: function(e) {
                    Xt(t, "active"), setTimeout((function() {
                        if (Xt(t, "visible"), ci(), n.activate(), e) {
                            var r = Wt('[data-id="'.concat(e, '"]'), t);
                            r && r.scrollIntoView()
                        }
                    }), 50)
                }
    ...
    _initSlider: function() {
        console.log("Init slideshow 2");
        var t = this,
            e = this.container.querySelector(cs);
        this.carousel = new $i.a(e, os(os({}, bs), {}, {
            on: {
                ready: function() {
    ...
    _checkForAccordions: function() {
        var t = this.container.querySelector(ms).querySelector(gs),
            e = this.container.querySelector(fs);
        e && t && this._appendSharingToAccordion(e, t)
    },
    _appendSharingToAccordion: function(t, e) {
        var n = t.outerHTML,
            r = as.product.share_heading,
            i = '\n      <div class="accordion product__share-accordion">\n        <div class="accordion__group">\n          <a class="accordion__label">'.concat(r, ' </a>\n          <div class="accordion__text">').concat(n, "</div>\n        </div>\n      </div>\n    ");
        e.insertAdjacentHTML("afterend", i);
        var o = this.container.querySelector(".product__share-accordion");
        this.accordion = C(o)
    ...
    _initHeightObserver: function() {
        var t = this;
        this._handleSectionHeight(), this.heightObserver = Ki((function() {
    ...
    _setSectionWrapperHeight: function() {
        this._setRootVar("--product-page-height", io() ? "".concat(this.detailsHeight, "px") : "unset")
    },
...
Es.prototype.initialize = function() {
    if (!this.containerElement) return;
    ({
        click: this.addClickListener,
        scroll: this.addScrollListeners
    })[this.settings.method]()
}, Es.prototype.addScrollListeners = function() {
...
}, Es.prototype.addClickListener = function() {
...
}, Es.prototype.preventMultipleClicks = function(t) {
...
}, Es.prototype.checkIfPaginationInView = function() {
...
}, Es.prototype.loadMore = function() {
...
}, Es.prototype.removeClickListener = function() {
    this.nextPageLinkElement.removeEventListener("click", this.preventMultipleClicks)
}, Es.prototype.removePaginationElement = function() {
    this.paginationElement.innerHTML = "", this.destroy()
}, Es.prototype.removeScrollListener = function() {
...
var As = function(t) {
    ...
    Is = function() {
        return function(t) {
            if (Ss()) return JSON.parse(localStorage.getItem("neon_" + t))
        }("closed_sidebar_groups") || []
    },
    Ns = function(t) {
        return function(t, e) {
            if (Ss()) return localStorage.setItem("neon_" + t, e)
    ...
    $s = "active",
    Ys = ".product-item",
    Js = ".collection__infinite-container",
    Ks = ".collection__infinite-trigger",
    Xs = "[data-sidebar]",
    Zs = "[data-partial]";
fe("collection", {
    infiniteScroll: null,
    onLoad: function() {
        var t, e = this,
            n = this.container.dataset.paginationType;
        this.paginationType = n, this.infiniteScrollTrigger = Wt(Ks, this.container), this.collection = function(t) {
            var e = new _s.a(t || window.location.href);

            function n(t) {
                var n = e.paths().slice(0, 2);
                e.paths([].concat(n, [t]))
            }

            function r() {
                var t = e.paths().filter(Boolean);
                return t[2] ? t[2].split(" ") : []
            }
            return {
                getState: function() {
                    return {
                ...
                addTags: function(t, i) {
                    return n([].concat(r(), t).filter((function(t, e, n) {
                        return n.indexOf(t) == e
                    })).join(" ")), delete e.query.page, i(this.getState())
                },
                ...
                clearAll: function(t) {
                    return delete e.query.sort_by, n(""), t(this.getState())
                }
            }
            ...
            var e = Gt(Ms, t),
                n = Gt(Rs, t),
                r = Jt(t, "click", (function(t) {
                    t.preventDefault();
                    var e = t.target.dataset,
                        n = e.heading,
                        r = e.tag,
                        i = e.sort;
                    r && (z().tags.includes(r) ? Ls([r]) : As([r]));
                    i && (z().sort_by === i ? xs() : ks(i));
                    if (n) {
                        console.log(t.target);
                        var o = t.target.nextElementSibling;
                        v(o);
                        var a = Is();
                        y(o) ? (Xt(t.target, Ds), g(o), Ns([].concat(Ct()(a), [n]))) : (Zt(t.target, Ds), m(o), Ns(a.filter((function(t) {
                            return t !== n
                        }))))
                    }
                })),
                i = R("tags", (function(t) {
                    ...
                    return e.forEach((function(t) {
                        return Qt(t.parentElement, Ps, n.includes(t.dataset.tag))
                    }))
                })),
                o = R("sort_by", (function(t) {
                    var e = t.sort_by;
                    return n.forEach((function(t) {
                        return Qt(t.parentElement, Ps, t.dataset.sort === e)
                    }))
                }));
            return Is().forEach((function(e) {
                    var n = Wt(Bs(e), t);
                    n && (Xt(Wt(js, n), Ds), g(n.querySelector("ul"), {
                        duration: 1
                    }))
                })),
                function() {
        ...
        }(this.container.querySelector(Xs)), this.filtering = function(t) {
            var e = Gt(zs, t),
                n = Wt(Us, t),
                r = Gt(Vs, t),
                i = Gt('[data-filter-flyout="__sort"] '.concat(Ws)),
                o = null,
                a = [Jt(Gt(Hs, t), "click", (function(e) {
                    e.preventDefault();
                    var r = e.currentTarget.dataset.filter,
                        i = Wt('[data-filter-flyout="'.concat(r, '"]'), t);
                    (o = bt(i, {
                        allowOutsideClick: !0
                    })).activate(), Xt(n, $s), Xt(i, $s), ci(t, {
                        allowTouchMove: function(t) {
                            for (; t && t !== document.body;) {
                ...
                })), Jt(r, "click", (function(t) {
                    t.preventDefault(), Qt(t.target.parentNode, $s)
                })), Jt(i, "click", (function(t) {
                    if (t.preventDefault(), te(t.currentTarget.parentNode, $s)) return;
                    i.forEach((function(e) {
                        return Qt(e.parentNode, $s, e === t.currentTarget)
                    }))
                })), Jt(n, "click", u), Jt(Gt(Fs, t), "click", (function(t) {
                    t.preventDefault();
                    var e = t.currentTarget.dataset.button,
                        n = t.currentTarget.closest(zs);
                    if ("__sort" === n.dataset.filterFlyout) {
                        if ("clear" === e && Zt(i.map((function(t) {
                                return t.parentNode
                            })), $s), "apply" === e) {
                            var r = Wt(".".concat($s), n);
                            return r ? ks(r.firstElementChild.dataset.sort) : xs(), void u()
                        }
                    } else {
                        var o = Gt(Vs, n);
                        if ("clear" === e && Zt(o.map((function(t) {
                                return t.parentNode
                            })), $s), "apply" === e) {
                            var a = [],
                                s = [];
                            o.forEach((function(t) {
                                var e = t.parentNode,
                                    n = t.dataset.tag;
                                te(e, $s) ? a.push(n) : s.push(n)
                            })), s.length > 0 && Ls(s, a.length <= 0), a.length > 0 && As(a), u()
                        }
                    }
                })), Jt(Gt(Gs, t), "click", u)],
                s = R("tags", (function(t) {
                    var e = t.tags;
                    return r.forEach((function(t) {
                        return Qt(t.parentElement, $s, e.includes(t.dataset.tag))
                    }))
                })),
                c = R("sort_by", (function(t) {
                    var e = t.sort_by;
                    return i.forEach((function(t) {
                        return Qt(t.parentElement, $s, t.dataset.sort === e)
                    }))
                }));

            function u(r) {
                r && r.preventDefault(), o && o.deactivate(), Zt([].concat(Ct()(e), [n]), $s), ui(t)
            }
            return function() {
        ...
        }(this.container), H(this.collection.getState()), this.partial = Wt(Zs, this.container), this.subscriptions = [(t = function(t, n) {
            var r = n.tags;
            return e.collection.addTags(r, (function(t) {
                e._renderView(t.url), H(t)()
            }))
        }, R("collection:filters:add", t)), Ts((function(t, n) {
            var r = n.tags,
                i = n.fetch;
            e.collection.removeTags(r, (function(t) {
                i && (e._renderView(t.url), H(t)())
            }))
        })), qs((function(t, n) {
            var r = n.method;
        ...
        }))], this.delegate = new Po.a(this.partial), this.delegate.on("click", '[data-pill="filter"]', (function(t) {
            t.preventDefault();
        ...
        })), this._initInfiniteScroll(), this._initProductItems(), this.collectionUpdatedHanlder = R("collection:updated", (function() {
    ...
    _initInfiniteScroll: function() {
        if (!("paginated" === this.paginationType)) {
            var t = {
                container: Js,
                pagination: Ks,
                loadingText: "Loading...",
                callback: function() {
                    return B("collection:updated")
                }
            };
            "click" === this.paginationType && (t.method = "click"), Es.prototype.loadMore = function() {
                this.request = new XMLHttpRequest, this.request.onreadystatechange = function() {
            ...
            }, this.infiniteScroll = new Es(t)
        }
    },
    _initProductItems: function() {
        var t = this,
            e = this.container.querySelectorAll(Ys);
        this.productItems = [], e.forEach((function(e) {
            t.productItems.push(Ho(e))
        }))
    },
    _renderView: function(t) {
        var e = this,
            n = Wt(".collection__loading", this.container);
        Xt(n, "is-active"), fetch(t, {
            credentials: "include"
        }).then((function(t) {
            return t.text()
        })).then((function(r) {
            ...
            var i = (new window.DOMParser).parseFromString(r, "text/html"),
                o = Wt(Zs, i).innerHTML;
            e.partial.innerHTML = o, e.infiniteScrollTrigger.innerHTML = "", e._initInfiniteScroll(), Zt(n, "is-active"), B("collection:updated")
        }))
    },
    onUnload: function() {
...
var Qs = "#RecoverPassword",
    tc = "#RecoverPasswordForm",
    ec = "#HideRecoverPasswordLink",
    nc = "#CustomerLoginForm",
    rc = ".reset-password-success",
    ic = "#ResetSuccess";
...
fe("login", {
    ...
    _toggleRecoverPasswordForm: function() {
        this.container.querySelector(tc).classList.toggle("hide"), this.customerLoginForm.classList.toggle("hide")
    },
    _resetPasswordSuccess: function() {
        var t = this.container.querySelector(rc),
            e = this.container.querySelector(ic);
        t && e.classList.remove("hide")
    },
    onUnload: function() {}
}), oc.prototype.build = function(t, e, n) {
    ...
    if (n = n || {}, t.innerHTML = this.countryOptions, t.value = r, r && ac(t, r)) {
        var i = sc(t, e, r);
...
var cc = "[data-address]",
    uc = "[data-address-toggle]",
    lc = "[data-address-country]",
    dc = "[data-address-province]",
    hc = "[data-address-province-wrapper]",
    fc = "[data-address-form]",
    pc = "[data-address-delete-form]";
fe("addresses", {
    onLoad: function() {
        var t = this,
            e = this.container.querySelectorAll(cc);
        if (e.length) {
            var n = new oc(window.theme.allCountryOptionTags);
            e.forEach((function(e) {
    ...
    _initializeAddressForm: function(t, e) {
        var n = e.querySelector(lc),
            r = e.querySelector(dc),
            i = e.querySelector(hc),
            o = e.querySelector(fc),
            a = e.querySelector(pc);
        t.build(n, r, {
            onCountryChange: function(t) {
                return i.classList.toggle("hide", !t.length)
            }
        }), e.querySelectorAll(uc).forEach((function(t) {
...
var mc = "[data-js-toggle]";
if (fe("password", {
        onLoad: function() {
            var t = this;
            this.toggleButton = this.container.querySelector(mc), this.toggleButton.addEventListener("click", (function(e) {
    ...
    var gc = document.querySelector(".theme-editor-scroll-offset");
    gc && gc.remove()
}
var vc = document.querySelectorAll(".accordion");

function yc(t) {
    9 === t.keyCode && (document.body.classList.add("user-is-tabbing"), window.removeEventListener("keydown", yc), window.addEventListener("mousedown", bc))
}

function bc() {
    document.body.classList.remove("user-is-tabbing"), window.removeEventListener("mousedown", bc), window.addEventListener("keydown", yc)
}
vc.length && vc.forEach((function(t) {
    C(t)
})), $(document.querySelector(".header-container")), tt(document.querySelector("[data-header-overlay]")), it(document.querySelector("[data-drawer-overlay]")), je(document.querySelector("[data-modal]")), ze(document.querySelector("[data-store-availability-drawer]")), window.addEventListener("keydown", yc);
var wc = function() {
...
/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream && wc(), document.querySelectorAll("table").forEach((function(t) {
var e = document.createElement("div");
e.classList.add("rte-table"), t.parentNode.insertBefore(e, t), e.appendChild(t)
}))
}]);
 ...
 $(document).ready(function(){
    ...
    $(".accordion_row").click(function(){
      ...
      $(this).children('h3').css("color","#007c85");
      //$(this).children('h3:after').css("content","\2212");
      $(this).toggleClass("active");
    });
  
   
   $(".howmaywe-btn.btn-submit").click(function(){
     // console.log('ddddd');

      var checkboxValues = [];
      var list ='';
      $('.howmaywe-taglist-sec input:checked').map(function() {
     ...
     // console.log(list);
      ...
      var url = path1+'/collections/all/'+list;
     // console.log(url);
...
//               $("#ecom_transform").css("transform","translate3d(-300px, 0px, 0px)");
//             }else{
//               // false for not mobile device
//              // document.write("not mobile device");
//                $("#ecom_transform").css("transform","translate3d(-699px, 0px, 0px)");
//             }
        $(".owl-item").hide();
        $(".timeofdays_sec").show();
          //console.log('ff');
          $("#progress-bar_ecom").css('width','50%');
      ...
      $(".timeofdays_Btn").click(function(){
       
        
//          if(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)){
//               // true for mobile device
//              // document.write("mobile device");
//               $("#ecom_transform").css("transform","translate3d(-600px, 0px, 0px)");
//             }else{
//               // false for not mobile device
//              // document.write("not mobile device");
//                $("#ecom_transform").css("transform","translate3d(-1398px, 0px, 0px)");
//             }
        $(".owl-item").hide();
        $(".caffeine_level_sec").show();
        //console.log('2222222222');
        $("#progress-bar_ecom").css('width','75%');
        var type = $(this).attr("data-search");
        //
        link +='+'+type;
        //console.log(link);
      ...
      $(".caffeine_level_Btn").click(function(){
       
        
//         if(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)){
//               // true for mobile device
//              // document.write("mobile device");
//               $("#ecom_transform").css("transform","translate3d(-900px, 0px, 0px)");
//             }else{
//               // false for not mobile device
//              // document.write("not mobile device");
//                 $("#ecom_transform").css("transform","translate3d(-2097px, 0px, 0px)");
//             }
         $(".owl-item").hide();
        $(".view_pro_sec").show();
       // console.log('3333333333');
        $("#progress-bar_ecom").css('width','100%');
        var type = $(this).attr("data-search");
        //
        link +='+'+type;
        //console.log(link);
        $("#question-link").attr('href', '/collections/all/'+link+'');
      });
   ...
   $(".reset-questions").click(function(){
    $(".owl-item").hide();
        $(".tea_type_sec").show();
    //$("#ecom_transform").css("transform","translate3d(0px, 0px, 0px)");
       $("#progress-bar_ecom").css('width','25%');
...
//   x.className = "show";
// x.innerText = "Item Added";
//   // After 3 seconds, remove the show class from DIV
//   setTimeout(function(){ x.className = x.className.replace("show", ""); }, 3000);
// }


function showSnack(productID, thisElem) {
  setTimeout(function(){
    $('[data-variant="'+productID+'"]').text("Add To Cart");
    $('[data-variant="'+productID+'"]').attr("disabled",false);
  },2000)
  // Get the snackbar DIV
 // var x = document.getElementById("snackbar");
...
$(document).ready(function(){
  ...
  normal_cart_data2();
  //=============== footer warp start
  var divs = $(".footer_Left > div");
divs.slice(1, 3).wrapAll("<div class='footer_sub_warp'></div>");
  //==============================end 
...
//show how far for free shipping and hide default announcement
      $("#default-announcement-ecom").hide();
      $("#ecom_shipping_ammount").show();
        
          var productID = $(this).attr("data-variant");
          console.log({productID});
         //$(".loading_"+productID).css("display","flex"); //removed for view adding 
        $(this).text("Adding");
        $(this).attr("disabled", true);
          ...
          jQuery.ajax({
            ...
            dataType: 'json',
            data: {
            quantity: 1,id: productID },
            cache: false,
            success: function(data){
             //console.log(data);
              
              addtocart_callback(data, productID);
            // $(".pluse_btn").prop("disabled",false);
              
              //disaply sidecart[minicart, mini cart, side cart] after adding item
			//document.querySelector('.quick-cart__trigger2').dispatchEvent(new Event("click"));
              setTimeout(function(){
                 $('[data-variant="'+productID+'"]').text("Added")
             	//showSnack(productID)
              },1000)
        ...
        $('#shopify-section-product-recommendations--static').on("click", ".addtocart_btn", function(event) {
     // $(".addtocart_btn").click(function(){
      ...
      $("#ecom_shipping_ammount").show();
          ...
          var productID = $(this).attr("data-variant");
         $(".loading_"+productID).css("display","flex");
          //--------Post  request
          jQuery.ajax({
            type: 'POST',
            url: '/cart/add.js',
...
//======================================================
//          popup cart plus icon +
//======================================================
 function addcartbtn(productID,price){
     jQuery.ajax({
        type: 'POST',
        url: '/cart/add.js',
        data: {
...
//==========================================================
//           popup cart minus icon -
//==========================================================
 function minuscartbtn(productID,price){

   
     var e_qty = $(".popup_qty_"+productID+"").text();
     e_qty = parseInt(e_qty);
     console.log('e_qty-- >> '+e_qty);
   ...
   var tot2 = $(".csapps-cart-original-total span").text();
   
   var tot = (tot2.replace(/\D/g,''))/100;
    //var tot = $(".js-subtotal").text();
     tot = parseFloat(tot);
   
     console.log('M tot '+tot);
    var price = parseFloat(price);
     console.log('M price '+price);
     var Total = tot - price;
     console.log('M Total '+Total);
     $(".csapps-cart-original-total span").text('$'+Total.toFixed(2));
   ...
   //=======================================================
   //        cart pop up box display
   //=======================================================
   $(".quick-cart__trigger2").click(function(event){
     event.preventDefault();
       $(".cart-flyout").addClass("is-visible");
       $(".drawer-overlay").addClass("is-active");
       $(".drawer-overlay__inner").addClass("is-visible");
      // normal_cart_data2();
   ...
   //quick-cart__close js-close
    $(".quick-cart__close").click(function(event){
       event.preventDefault();
       $(".cart-flyout").removeClass("is-visible");
       $(".drawer-overlay").removeClass("is-active");
       $(".drawer-overlay__inner").removeClass("is-visible");
      // normal_cart_data2();
   });
...
//======================================================
  ...
  //======================================================                 
  function addtocart_callback(response,productID) {
...
//            //--------De active addign icon
//            $(".ecom-addtocart.cart_"+productID+" .loading_cart").removeClass("active");
...
//console.log('wwwww 33');
    var cartcount = cart.item_count;
    var original_total_price =  cart.original_total_price;
     
    let ecom_free_shipping = shipping_amount.toString();
    ecom_free_shipping = parseFloat(ecom_free_shipping.replace(/[^\d+.]/g,"") );

      if(isNaN(ecom_free_shipping )) {
        return
      }

      load_cartdata_callback(cart.items,cartcount,original_total_price);
      $(".quick-cart__indicator-inner").text(cartcount);
    const shippping_elem_minicart = document.querySelector(`#ecomtxt`);
      
    if(ecom_free_shipping > (cart.total_price /100)) {
      const shipping_elem = document.getElementById("msgecom");
      shipping_elem.innerText = `You are  US$${ (ecom_free_shipping- (cart.total_price/100)).toFixed(2)} away from free shipping.`;
      shippping_elem_minicart.innerHTML = `You are  <b><i>US$${ (ecom_free_shipping- (cart.total_price/100)).toFixed(2)}</i></b> away from <b>free shipping.</b>`;
      
      const cart_page_ecom_free_shipping = document.getElementById("ecom_free_shipping");
      if(cart_page_ecom_free_shipping) {
      	cart_page_ecom_free_shipping.innerHTML = `You are  <b><i>US$${ (ecom_free_shipping- (cart.total_price/100)).toFixed(2)}</i></b> away from free shipping.`;
      }
      
    } else {
      const shipping_elem = document.getElementById("msgecom");
      shipping_elem.innerText = "You are eligible for free shipping";
      shippping_elem_minicart.innerHTML = "You are eligible for free shipping";
      
      const cart_page_ecom_free_shipping = document.getElementById("ecom_free_shipping");
      if(cart_page_ecom_free_shipping) {
      	cart_page_ecom_free_shipping.innerHTML ="You are eligible for free shipping";
      }
    }
      //if cart have items then show the away message
      if(cart.item_count >0) {
        document.getElementById("ecom_shipping_ammount").style.display = "flex";
        document.getElementById("default-announcement-ecom").style.display = "none";
        shippping_elem_minicart.style.display = "";
      } else {
        document.getElementById("ecom_shipping_ammount").style.display = "none";
        document.getElementById("default-announcement-ecom").style.display = "";
        shippping_elem_minicart.style.display = "none";
      }
	//show sidecart after adding item
...
//============================================================
function load_cartdata_callback(response,cartcount,original_total_price){
 ...
 $(".product_btn span").css("display","none");
    ...
    for(var i=0; i < cartdataArry.length; i++){
      ...
      +' <span class="quick-cart__product-price-value qqq">US$'+cartdataArry[i].price/100+' <span></span>'
      +'</span>'
      +'</span>'
      +'</div>'
      +'</div>'
...
//console.log('nnnnnnnnnnnnnnnnnn'+tr);
  //  $(".quick-cart__items").empty();
  // $( ".quick-cart__items" ).append(tr);
...
$( "#gift_cart_check" ).change(function() {
  if($("#gift_cart_check").is(":checked")){
  ...
  //----------------------------------------------
// var old_data='';
// $(".mega-navigation .nav__item a, .mega-navigation__list-heading a").hover(function(){
//    $(".nav_right_img").hide();
//     $(".nav_right_description").text("");
//       $(".nav_right_title h3").text("");
//       $(".nav_right_img img").attr("src", "#");
//      var a = $(this).attr("href");
//     // console.log(a);
//      var link =  a+'/our-favourites.json';
...
//       // console.log(jsonArray.collection.title);
//       //console.log(jsonArray.collection.description);
//       //  console.log(jsonArray.collection.image); 
//      //   console.log('jsonArray -- >> '+jsonArray);
//       var subaary = JSON.parse(JSON.stringify(jsonArray.collection.image));
//     // console.log(subaary.src);


//       // console.log('aaaadd -- >> '+collection.title);
//        $(".mega-navigation__featured-wrapper").hide();
       
       
//        if(subaary){
//         $(".nav_right_img img").attr("src", subaary.src);
//  $(".nav_right_img").show();
//        }
//         $(".nav_right_description").text(jsonArray.collection.description);
       

       
//        // $(".nav_right_title").find("h3").animate({opacity:0},function(){
//             $(".nav_right_title h3").text(jsonArray.collection.title);
//           //      .animate({opacity:1});  
//        // });
...
// });
  ...
  $('#sender-email-id, #sender-name, #recipient-email-id, #recipient-name').keyup(function(e){
        var sendername = '';
        var senderemailid = '';
        var recipientname = '';
        var recipientemailid = '';
        var sendername = $.trim($("#sender-name").val());
        var senderemailid = $.trim($("#sender-email-id").val());
        var recipientname = $.trim($("#recipient-name").val());
        var recipientemailid = $.trim($("#recipient-email-id").val());

      if(sendername !='' &&  senderemailid!='' && recipientname!='' && recipientemailid!=''){
           $(".product-form__cart-submit").prop('disabled', false);
...
//navImgLoop(); 
   ...
   // var perant_li = $(".ecom-submenu-right-side").length;
   // var n = 0;
   // console.log('aaaaaaaaa'+perant_li);

   // for (i = 0; i < perant_li; i++) {

           // x[i].style.display = "none";

           //var x = $(".ecom-submenu-right-side:eq(0) .ecom-submenu-right-side:eq("+i+") .nav_right_sec").length;
//            var x = $(".ecom-submenu-right-side:eq(0) .nav_right_sec").length;
...
//                    var n =  z + 1;
//                     console.log('n---->> '+n);
//                    $(".ecom-submenu-right-side:eq(0) .nav_right_sec:eq("+n+")").hide();
...
//             }
  ...
  //==========================================================================
  var loopcount = 4;
  for (Q = 1; Q < loopcount; Q++) {
  
  
     var li_2 = $(".ecom-submenu-left-side:eq("+Q+") ul li.mega-navigation__list.sub-1").length;
      for (y = 0; y < li_2; y++) {

        if(y == 0){
            //console.log('aaaa --- >> '+y);
            $(".ecom-submenu-right-side:eq("+Q+")").empty();
        }

        var chilsitem = $(".ecom-submenu-left-side:eq("+Q+") ul li.mega-navigation__list.sub-1:eq("+y+") ul.list li").length;

       // console.log('chilsitem -- >> '+chilsitem);
        for (c = 0; c < chilsitem; c++) {

           // console.log('ccc  jj--- >> '+c);
            var dataname = $(".ecom-submenu-left-side:eq("+Q+") ul li.mega-navigation__list.sub-1:eq("+y+") ul.list li:eq("+c+")").attr("data-name");
          //  console.log('dataname -- >> '+dataname);  
            var code =' <div class="nav_right_sec 1   '+dataname+'" data-link="#">'
                      +'<div class="nav_right_img"><img style=" height: 100%;" src=""></div>'
                      +'<div class="nav_right_title"><h3></h3></div>'
                      +'<div class="nav_right_description"></div>'
                      +'</div>';

             $( ".ecom-submenu-right-side:eq("+Q+")" ).append(code);
 ...
 //-----------------------------------------
  for (Q = 1; Q < loopcount; Q++) {
      var n = 0;
      var x = $(".ecom-submenu-right-side:eq("+Q+") .nav_right_sec").length;
         //console.log('zzzz --- >> '+x);
      for (z = 0; z < x; z++) {
         // console.log('zzzz --- >> '+z);
          var n =  z + 1;
          //console.log('n---->> '+n);
          $(".ecom-submenu-right-side:eq("+Q+") .nav_right_sec:eq("+n+")").hide();
      }
  }  
  //-------------------------------------------
  ...
  //nav__item
  $(".ecom-submenu-left-side:eq(1) .nav__item").hover(function(){
    
    var classname = $(this).attr("data-name");
   // console.log('dddd --- >> '+a);
    $(".ecom-submenu-right-side:eq(1) .nav_right_sec").hide();
    $(".ecom-submenu-right-side:eq(1) .nav_right_sec."+classname).show();

   //ecom-submenu-right-side
   ...
   //nav__item
  $(".ecom-submenu-left-side:eq(2) .nav__item").hover(function(){
    
    var classname = $(this).attr("data-name");
   // console.log('dddd --- >> '+a);
    $(".ecom-submenu-right-side:eq(2) .nav_right_sec").hide();
    $(".ecom-submenu-right-side:eq(2) .nav_right_sec."+classname).show();
   ...
   //nav__item
  $(".ecom-submenu-left-side:eq(3) .nav__item").hover(function(){
    
    var classname = $(this).attr("data-name");
   // console.log('dddd --- >> '+a);
    $(".ecom-submenu-right-side:eq(3) .nav_right_sec").hide();
    $(".ecom-submenu-right-side:eq(3) .nav_right_sec."+classname).show();
  ...
  var x = $(".ecom-submenu-right-side:eq(0) .nav_right_sec").length;
      ...
      //====================================
  //ecom first menu items hover show image in right side
      $(".ecom-submenu-left-side:eq(0) ul li.mega-navigation__list ul li.nav__item").hover(function(){
    
      var classname = $(this).attr("data-name");
      // console.log('dddd --- >> '+a);
      $(".ecom-submenu-right-side:eq(0) .nav_right_sec").hide();
      $(".ecom-submenu-right-side:eq(0) .nav_right_sec."+classname).show();
  ...
  //     loging
  //=================================================
  $(".ecom_loging_btn_block").click(function(event){
      ...
      req.open("POST", " https://8663-2402-4000-2280-ccb1-38b5-c24d-83de-f4ee.ngrok.io/ustore/customer_verification.php", true);
      //req.open("POST", "https://ustoreapps.secureapps.center/customer_verification", true);
      req.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
      req.send("email=" + CustomerEmail);
  ...
  $(".ecom_register_btn_block").click(function(event){
...
function navImgLoop() {         
  setTimeout(function() {   
    ...
    var no = i-1;
     ...
     var a = $(".ecom-submenu-right-side:eq(0) .nav_right_sec:eq("+no+")").attr("data-link");
     var link =  a+'/our-favourites.json';
            ...
            $.get(link, function(data, status){
                ...
                var jsonArray = JSON.parse(JSON.stringify(data));
                var img = JSON.parse(JSON.stringify(jsonArray.collection.image.src));
                var description = JSON.parse(JSON.stringify(jsonArray.collection.description));
                var title = JSON.parse(JSON.stringify(jsonArray.collection.title));

              if(description){
               var des = removeTags(description);
              }else{
              var des = '';
              }
            
                // console.log('subaary -- >> '+img);
                // console.log('aaaa -- >> '+des);
                // console.log('title -- >> '+title);
                // console.log('title -- >> '+i);
                 
                               
                 $(".ecom-submenu-right-side:eq(0) .nav_right_sec:eq("+no+") .nav_right_img img").attr("src", img);
                $(".ecom-submenu-right-side:eq(0) .nav_right_sec:eq("+no+") .nav_right_img img").attr("loading", "lazy");
                 $(".ecom-submenu-right-side:eq(0) .nav_right_sec:eq("+no+") .nav_right_description").text(des);
            });
    ...
    var itemcount = $(".ecom-submenu-right-side:eq(0) .nav_right_sec").length;
    if (i < itemcount) {    //  if the counter < 10, call the loop function
      navImgLoop();             //  ..  again which will trigger another 
...
var k1 = 0;                  
// var old_data='';
function navImgLoop1() {         
  setTimeout(function() {   
    // console.log('hello');   
    // console.log('fir -- > '+k1);
        var no_1 = k1-1;
     // var a = $(".ecom-submenu-right-side:eq(1) .nav_right_sec:eq("+i+")").attr("data-link");
     var a = $(".ecom-submenu-left-side:eq(1)").find(".mega-navigation__list-parent li ul.list li.nav__item:eq("+no_1+")").attr("data-link");
    
    // console.log('+==========================--- >>> '+no_1);
    var link =  a+'/our-favourites.json';
    
    // console.log('link aa --- >>> '+link);
            ...
            $.get(link, function(data, status){
              ...
              var des = '';
                 ...
                 $(".ecom-submenu-right-side:eq(1) .nav_right_sec:eq("+no_1+") .nav_right_img img").attr("src", img);
                $(".ecom-submenu-right-side:eq(1) .nav_right_sec:eq("+no_1+") .nav_right_img img").attr("loading", "lazy");
                 $(".ecom-submenu-right-side:eq(1) .nav_right_sec:eq("+no_1+") .nav_right_title h3").text(title);
                 $(".ecom-submenu-right-side:eq(1) .nav_right_sec:eq("+no_1+") .nav_right_description").text(des);
              
            });
       
   // console.log('+==========================--- >>> '+no_1);
    
    k1++;   //  increment the counter
   
   // var itemcount = $(".ecom-submenu-right-side:eq(0) .nav_right_sec").length;
    var itemcount = $(".ecom-submenu-left-side:eq(1)").find("ul .nav__item").length;
    if (k1 < itemcount) {    //  if the counter < 10, call the loop function
      navImgLoop1();             //  ..  again which will trigger another 
...
var k2 = 0;                  
// var old_data='';
function navImgLoop2() {         
  setTimeout(function() {   
    // console.log('hello');   
    // console.log('fir -- > '+k2);
        var no_2 = k2-1;
     // var a = $(".ecom-submenu-right-side:eq(1) .nav_right_sec:eq("+i+")").attr("data-link");
     var a = $(".ecom-submenu-left-side:eq(2)").find(".mega-navigation__list-parent li ul.list li.nav__item:eq("+no_2+")").attr("data-link");
...
//                  console.log(' 2 title -- >> '+title);
                // console.log(' no_2 -- >> '+no_2);
                 ...
                 $(".ecom-submenu-right-side:eq(2) .nav_right_sec:eq("+no_2+") .nav_right_img img").attr("src", img);
                 $(".ecom-submenu-right-side:eq(2) .nav_right_sec:eq("+no_2+") .nav_right_img img").attr("loading", "lazy");
                 $(".ecom-submenu-right-side:eq(2) .nav_right_sec:eq("+no_2+") .nav_right_title h3").text(title);
                 $(".ecom-submenu-right-side:eq(2) .nav_right_sec:eq("+no_2+") .nav_right_description").text(des);
              
            });
       
    //console.log('+==========================--- >>> '+no_2);
    
    k2++;   //  increment the counter
   
   // var itemcount = $(".ecom-submenu-right-side:eq(0) .nav_right_sec").length;
    var itemcount = $(".ecom-submenu-left-side:eq(2)").find("ul .nav__item").length;
    if (k2 < itemcount) {    //  if the counter < 10, call the loop function
      navImgLoop2();             //  ..  again which will trigger another 
...
var k3 = 0;                  
// var old_data='';
function navImgLoop3() {         
  setTimeout(function() {   
    // console.log('hello');   
     //console.log('fir -- > '+k3);
        var no_3 = k3-1;
     // var a = $(".ecom-submenu-right-side:eq(1) .nav_right_sec:eq("+i+")").attr("data-link");
     var a = $(".ecom-submenu-left-side:eq(3)").find(".mega-navigation__list-parent li ul.list li.nav__item:eq("+no_3+")").attr("data-link");
    ...
    // console.log('link aa --- >>> '+link);
            ...
            $.get(link, function(data, status){
                ...
                // console.log(' no_3 -- >> '+no_3);
                 ...
                 $(".ecom-submenu-right-side:eq(3) .nav_right_sec:eq("+no_3+") .nav_right_img img").attr("src", img);
                $(".ecom-submenu-right-side:eq(3) .nav_right_sec:eq("+no_3+") .nav_right_img img").attr("loading", "lazy");
                 $(".ecom-submenu-right-side:eq(3) .nav_right_sec:eq("+no_3+") .nav_right_title h3").text(title);
                 $(".ecom-submenu-right-side:eq(3) .nav_right_sec:eq("+no_3+") .nav_right_description").text(des);
   ...
   // var itemcount = $(".ecom-submenu-right-side:eq(0) .nav_right_sec").length;
    var itemcount = $(".ecom-submenu-left-side:eq(3)").find("ul .nav__item").length;
    if (k3 < itemcount) {    //  if the counter < 10, call the loop function
      navImgLoop3();             //  ..  again which will trigger another 
...
var i = 0;                  
 var old_data='';
function navImgLoop_2() {         
  setTimeout(function() {   
     //console.log('hello');   
     //console.log('fir -- > '+i);
    
    var a = $(".nav__item.nav__item-parent:eq("+i+")").find(".mega-navigation__list-heading a:eq(0)").attr("href");
    var count = a.length;
    if(count < 5){
           var a = $(".nav__item.nav__item-parent:eq("+i+")").find(".nav__item:eq(0) a").attr("href");
    }
   // console.log('sec --- >> '+i);
    var link =  a+'/our-favourites.json';
       ...
       if(link != old_data){
            ...
            $.get(link, function(data, status){
                ...
                var title = JSON.parse(JSON.stringify(jsonArray.collection.title));
                 ...
                 $(".nav__item.nav__item-parent:eq("+no+")").find(".mega-navigation__featured-wrapper").hide();
                 $(".nav__item.nav__item-parent:eq("+no+")").find(".nav__submenu .mega-navigation-wrapper ul.mega-navigation .nav_right_sec .nav_right_img img").attr("src", img);
               $(".nav__item.nav__item-parent:eq("+no+")").find(".nav__submenu .mega-navigation-wrapper ul.mega-navigation .nav_right_sec .nav_right_img img").attr("loading", "lazy");
                 $(".nav__item.nav__item-parent:eq("+no+")").find(".nav__submenu .mega-navigation-wrapper ul.mega-navigation .nav_right_sec .nav_right_img").show();
                 $(".nav__item.nav__item-parent:eq("+no+")").find(".nav__submenu .mega-navigation-wrapper ul.mega-navigation .nav_right_sec .nav_right_description").text(des);
                 $(".nav__item.nav__item-parent:eq("+no+")").find(".nav__submenu .mega-navigation-wrapper ul.mega-navigation .nav_right_sec .nav_right_title h3").text(title);      
    ...
    i++;   //  increment the counter
     ...
     //var itemcount = $(".ordered_details").children('tr').length;
    var itemcount = $(".nav__item.nav__item-parent").length;
...
//       added on 10/2/2021
      $(document).ready(function(){
//         setTimeout(function() { 
//          $('#shopify-product-reviews').detach().appendTo('.review_wrapper');
//         }, 8000); // for 5 second delay 
        
                //bring review to down start
...
const searchInterval = setInterval(function(){
    const bb =document.querySelectorAll(`script[src*="productreviews.shopifycdn.com/"]`)
   // console.log(bb)
    if(bb.length >=2) {
        console.log("found")
        ...
        setTimeout(function(){
             try{
               $('#shopify-product-reviews').detach().appendTo('.review_wrapper');
                const side_review = document.querySelector(`.drawer.reviews-flyout`);
                side_review.parentNode.removeChild(side_review)
                const drawer_overlay = document.querySelector(`.drawer-overlay`);
                drawer_overlay.parentNode.removeChild(drawer_overlay)
                
                const review_open_sidebar = document.querySelectorAll(`.product__reviews-trigger.accent`)
                for(let i =0; i<review_open_sidebar.length; i++) {
                    review_open_sidebar[i].addEventListener("click", function(e){
                        e.preventDefault();
                        console.log("prevented")
    
                        const reviewContainer = document.querySelector(`.review_wrapper .spr-header-title`);
                        const pos = exactPosition(reviewContainer)
        ...
        //bring review to down end
        
        
         //console.log('loding slide');
       ...
       $(".collage").show();
               ...
               $.ajax({
                      ...
                      success: function() { 
                         // Shopify.clear();
                          ...
                          $(".ecom-cart-quick.js-items .cart__item").remove();
                          $(".clear_cart_data").text('0');
                          $(".quick-cart__indicator-inner").text('0');
                        normal_cart_data2();
                      }
              });
        });
        ...
        $(".ecom_priceCal").click(function(){
              var price =  $(".ecom_pro_price").attr("data-price");
              var qty = $("#Quantity-product--static").val();
              var p = price/100;

              var newprice = p * Number(qty);
              //console.log('sssss'+p+"---"+newprice.toFixed(2));
              $(".ecom_pro_price").text('US$'+newprice.toFixed(2));
        ...
        //========================================
        var new_count=0;
        $(".add_multi_BTN").click(function(){

          var pid =  $(this).attr('data-id');
          //var qty = 5;
           var qty =$(".multi_qty_"+pid).val();
          var qty = parseInt(qty);
          if(qty >0){
          
         
          
          var count = $(".ecom_add_disable .counter").text();
          var count2 = parseInt(count);
          
          
          
            //------------------------------------
             var new_count = parseFloat(count2)-parseFloat(qty);
            
            console.log('A new_count -- >> '+new_count);
          ...
          if(new_count >= 0){
             $(".alert_mulAdd").text("");
             $(".ecom_add_disable .counter").text(new_count);
             ...
             var bundle = $("#bundle").val();
              ...
              $("#bundle").val(data);
                ...
                if(new_count == 0){
                  ...
                  $(".ecom_add_disable").hide();
                  $(".cart_button").show();
                   $(".add_multi_BTN").addClass("disabled");
                  
                  
                   $([document.documentElement, document.body]).animate({
                        scrollTop: $(".product__header").offset().top
                    }, 2000);

                }else{
                  
                    $(".ecom_add_disable").show();
                    $(".cart_button").hide();
                   $(".add_multi_BTN").removeClass("disabled");
          ...
          console.log('cant add ');
            ...
            var amount = $('.counter').text();
             var amount = parseFloat(amount);
            if(amount >0){
            
           // you can only add two more item
            var alert= 'You can only add '+amount+' more item';
            $(".alert_mulAdd.alert_"+pid).text(alert);
            }
             ...
             $(".alert_mulAdd.alert_"+pid).text('You should add at least one item');
        ...
        //=========================================
        //Remove_multi_BTN
        $(".Remove_multi_BTN").click(function(){
          ...
          //removeClass
           ...
           var count = $(".ecom_add_disable .counter").text();
            var count2 = parseInt(count);
//            $(".ecom_add_disable .counter").text(count2+qty);
          // console.log('new qty-- >> '+count2);
             //====================================
            var data = '';
            var no ='';
            var Quentity = 0;
            var added_length = $(".multicolumn-list__item.active").length;
          
          console.log('added_length -- >> '+added_length);
          
            for (var i = 0; i < added_length; i++) {
                  var no = i;
                //  var qty  = $(".multicolumn-list__item.active:nth-child("+no+") .mul_qty input").val();
                 // var qty  = 5;
                  var qty  = $(".multicolumn-list__item.active .mul_qty input").eq( i ).val();
              
                  //var pid = $( ".multicolumn-list__item.active:nth-child("+no+")" ).attr("data-id");
                  var pid = $( ".multicolumn-list__item.active" ).eq( no ).attr("data-id");
           ...
           console.log('Quentity == '+Quentity);
            var count_o = $(".ecom_count_pro").attr("data-count");
            var count_o = parseInt(count_o);
            var newQTY =0;
            var newQTY = count_o - Quentity;
          
            $(".ecom_add_disable .counter").text(newQTY);
          ...
          //$(".multicolumn-list__item.active").length;
          if(added_length == 0){
          //var count_o = $(".ecom_count_pro").arrt("data-count");
           // $(".ecom_add_disable .counter").text(count_o);
                   $(".ecom_add_disable").show();
                    $(".cart_button").hide();
          }
            });
        ...
        $(".ecom_count_pro").click(function() {
            $([document.documentElement, document.body]).animate({
                scrollTop: $(".multicolumn").offset().top
            }, 2000);
        });
        ...
        $("#subject_topic").change(function(){
          
            var subject = $("#subject_topic").val();
          
            if( subject == 'Compliment' ||  subject == 'Complaint'){
                 $(".Order_Number").show();
                 $(".Subject").hide();
...
$(document).ready(function(){
 ...
 //send email to customer (auto responder)
    try{
      
    	document.getElementById("submit_btn").addEventListener('click', setContactCookie);
    } catch(e) {
      console.log("not in the contact form")
	}
  function setContactCookie(){
    console.log("running setcookie")
      const email = document.getElementById("ContactFormEmail").value;
      document.cookie = "sendEmail="+email+';path=/;'; 
      const fullName = document.getElementById("ContactFormName").value;
    document.cookie = "sendEmailName="+fullName+';path=/;'; 
  }
  ...
  function sendEmail(){
    ...
    const _data = JSON.stringify({
      "mail": getCookie('sendEmail'),
      "name": getCookie('sendEmailName'),
      "store":"glb"
    });
    ...
    xhr.addEventListener("readystatechange", function () {
      if (this.readyState === 4) {
        console.log(this.responseText);
        document.cookie = "sendEmail=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;";
    ...
    xhr.open("POST", "https://erp.dilmahtea.com/api/email-send");
...
try {
  const variantElements = [...document.querySelectorAll(`.product-form__option.js-enabled  span`)]
  const productID = document.querySelector(`[name="product_id"]`).value;
  const variantData = JSON.parse( document.querySelector(`#variant_data_${productID}`).innerText)
console.log(variantData)

for(let variantElem of variantElements) {
    const elemVariantOption =  variantElem.innerText.trim();
    
    for(let variant of variantData.variants) {
        if(variant.option_value == elemVariantOption) {
            const variance = variant.compare_at_price - variant.price;
            let saving = (variance *100) / variant.compare_at_price ;
            saving = Math.round(saving);
            console.log(variant)
			
            if(isFinite(saving) == false) {
              document.querySelector(`div[data-variant-option="${variant.option_value }"]`).style.display = "none";
            } else {
              
            document.querySelector(`div[data-variant-option="${variant.option_value }"]`).innerText ="Save " + saving +"%"
            }
        }
    }
}
  ...
  console.log('error in variant prices',e)
}

function showVariantData (optionValue, engraving=false) {
    const variantElements = [...document.querySelectorAll(`.product-form__option.js-enabled span`)]
    const productID = document.querySelector(`[name="product_id"]`).value;
  	const variantData = JSON.parse( document.querySelector(`#variant_data_${productID}`).innerText)
    
    const quantity = document.getElementById("Quantity-product--static").valueAsNumber || 1;
  
    for(let variant of variantData.variants) {
        if(variant.option_value == optionValue) {
            document.querySelector(`.product__header .product__price [data-compare-price]`).innerText = "US$ " + ( quantity * ( variant.compare_at_price /100 )).toFixed(2);
            document.querySelector(`.product__header .product__price [data-product-price]`).innerText = "US$ " + ( quantity * ( variant.price /100 ) ).toFixed(2);
            document.querySelector(`.product__price .product-price-m[data-product-price]`).dataset.price =  (  ( variant.price  ) );
            document.querySelector(`.product__price .product-price-m[data-product-price]`).innerText = "US$ " + ( quantity * ( variant.price /100 ) ).toFixed(2);
          
          //if this is engraving then hide and show engraving add to cart button
          if(engraving) {
            
            console.log(engraving)
            const engravingBtn = document.querySelector(".engraving_add_to_cart");
            if(!engravingBtn) {
              return;
            }

            //check value is without engraving
            console.log(variant)

            if(variant.allData.option1 != "Without Engraving") {
              document.querySelector(`form[action="/cart/add"] [type="submit"] `).style.display = "";
              document.querySelector(`form[action="/cart/add"] .engraving_add_to_cart`).style.display = "none";

              document.querySelector(`.ecom_engraving`).style.display = "";
              return;
            }

               //if there is option for without engraving hide the default add to cart and show ecom add to cart
              if(variant.allData.option1 == "Without Engraving") {
             
              document.querySelector(`form[action="/cart/add"] [type="submit"] `).style.display = "none";
              document.querySelector(`form[action="/cart/add"] .engraving_add_to_cart`).style.display = "";
              document.querySelector(`.ecom_engraving`).style.display = "none";
            }
...
//variant change then price change end
  
    
const variantDropdowns = document.querySelectorAll(`.variant-list-ul.dropdown-view`);
function variantDropdown (event) {
    const myUL = event.target.closest("ul");
    const isExpanded = myUL.getAttribute("data-expanded");
    const productID = myUL.dataset.productid;
    
    //expan or not check
    if(isExpanded == null ) {
        const relativeLI = myUL.querySelectorAll('li');
        for(let i =0; i < relativeLI.length; i++) {
            relativeLI[i].classList.remove("hide")
            relativeLI[i].classList.remove("active")
			relativeLI[i].classList.remove("inactive")
           
        }
        myUL.setAttribute("data-expanded","true")
        
        //change this actuve class to up arrow class if you need
        relativeLI[0].classList.add("inactive")
        //return after showing all
        return;
    }

    //when expand and user select the item
    let myLI ;
    if( event.target.tagName == "LI" ) {
        myLI = event.target;
    } else {
        myLI = event.target.closest("li");
    }

    //add all li to hide
    const relativeLI = myUL.querySelectorAll('li');
    for(let i =0; i < relativeLI.length; i++) {
        relativeLI[i].classList.add("hide")
		relativeLI[i].classList.remove("inactive")
    }
	
    myLI.classList.remove("hide")
    myLI.classList.add("active")
    myUL.removeAttribute("data-expanded")
    if(myUL == relativeLI[0] ) {
      
		relativeLI[0].classList.add("inactive")
    }
    const variantID = myLI.dataset.id;
    
    //adding variant to addtocart button
    const addToCartBtn = document.querySelector(`.ecom_addToCart[data-productid="${productID}"]`)
    addToCartBtn.setAttribute("data-variant", variantID)
}

document.addEventListener("click", function (event) {
    const ulclassList = event.target.closest("ul")?.classList;
    if(ulclassList && ulclassList.contains("variant-list-ul")) {
        variantDropdown(event)
    }
});
    ...
    $(document).ready(function(event){
    	document.querySelector(`.button-wrapper span`)?.click();
    })

//  my account page -- customer side bar 

function setActiveDash(){
  
  
  dashboard1.classList.add("activeSideBarItem");
  dashboard2.classList.add("activeListItem");
  dashboard1.classList.remove("sideBarListArea");
  dashboard2.classList.remove("sideBarListItems");


  profile1.classList.remove("activeSideBarItem");
  orders1.classList.remove("activeSideBarItem");
  reviews1.classList.remove("activeSideBarItem");
  credit1.classList.remove("activeSideBarItem");
  password1.classList.remove("activeSideBarItem");

  profile2.classList.remove("activeListItem");
  orders2.classList.remove("activeListItem");
  reviews2.classList.remove("activeListItem");
  credit2.classList.remove("activeListItem");
  password2.classList.remove("activeListItem");

  profile1.classList.add("sideBarListArea");
  orders1.classList.add("sideBarListArea");
  reviews1.classList.add("sideBarListArea");
  credit1.classList.add("sideBarListArea");
  password1.classList.add("sideBarListArea");

  profile2.classList.add("sideBarListItems");
  orders2.classList.add("sideBarListItems");
  reviews2.classList.add("sideBarListItems");
  credit2.classList.add("sideBarListItems");
  password2.classList.add("sideBarListItems");

  myDashboardArea.style.display="block";
  myProfileArea.style.display="none";
  myOrdersArea.style.display="none";
  reviewsArea.style.display="none";
  creditArea.style.display="none";
  changePasswordArea.style.display="none";
  
}

function setActiveProf(){
  myDashboardArea.style.display="none";
  ...
  profile1.classList.add("activeSideBarItem");
  profile2.classList.add("activeListItem");
  profile1.classList.remove("sideBarListArea");
  profile2.classList.remove("sideBarListItems");

  dashboard1.classList.remove("activeSideBarItem");
  orders1.classList.remove("activeSideBarItem");
  reviews1.classList.remove("activeSideBarItem");
  credit1.classList.remove("activeSideBarItem");
  password1.classList.remove("activeSideBarItem");

  dashboard2.classList.remove("activeListItem");
  orders2.classList.remove("activeListItem");
  reviews2.classList.remove("activeListItem");
  credit2.classList.remove("activeListItem");
  password2.classList.remove("activeListItem");

  dashboard1.classList.add("sideBarListArea");
  orders1.classList.add("sideBarListArea");
  reviews1.classList.add("sideBarListArea");
  credit1.classList.add("sideBarListArea");
  password1.classList.add("sideBarListArea");

  dashboard2.classList.add("sideBarListItems");
  orders2.classList.add("sideBarListItems");
  reviews2.classList.add("sideBarListItems");
  credit2.classList.add("sideBarListItems");
  password2.classList.add("sideBarListItems");
...
function setActiveOrders(){
  ...
  orders1.classList.add("activeSideBarItem");
  orders2.classList.add("activeListItem");
  orders1.classList.remove("sideBarListArea");
  orders2.classList.remove("sideBarListItems");
...
function setActiveReviews(){
  ...
  reviews1.classList.add("activeSideBarItem");
  reviews2.classList.add("activeListItem");
  reviews1.classList.remove("sideBarListArea");
  reviews2.classList.remove("sideBarListItems");
...
function setActiveCredit(){
  ...
  credit1.classList.add("activeSideBarItem");
  credit2.classList.add("activeListItem");
  credit1.classList.remove("sideBarListArea");
  credit2.classList.remove("sideBarListItems");
...
function setActivePassword(){
  ...
  password1.classList.add("activeSideBarItem");
  password2.classList.add("activeListItem");
  password1.classList.remove("sideBarListArea");
  password2.classList.remove("sideBarListItems");
...
//show hide menu panel in the mobile 
function showHidePanel(thisElem) {
  const isOpen = thisElem.dataset.open;
  const arrow = document.querySelector(`#sidePanelHideIcon .expandIconMyAcSidePanel`);
  
  if (isOpen == "false" ) {
      document.getElementById("1").style.width ="250px";
      document.getElementById("1").style.boxShadow ="rgb(0 0 0 / 80%) 0px 0px 0px 10000px";
      document.getElementById("two").style.filter ="blur(5px)";
  
      var spans = document.getElementById("1").getElementsByTagName("span");
      ...
      arrow.classList.add("rotateExpandIconMyAcSidePanel");
      
      sidePanelHideIcon.style.display="block";
      sidePanelOpenIcon.style.display="none";
      sidePanelContent.style.display="contents";
      
      thisElem.dataset.open = "true";
  }

  if(isOpen == "true") {
        document.getElementById("1").style.width ="";
      document.getElementById("1").style.boxShadow ="";
      document.getElementById("two").style.filter ="";
      ...
      arrow.classList.remove("rotateExpandIconMyAcSidePanel");
      sidePanelHideIcon.style.display="";
      sidePanelOpenIcon.style.display="";
      sidePanelContent.style.display="";
      thisElem.dataset.open = "false";
  }
}
...
//--show and hd snow effecton hover - start
...
//--show and hd snow effecton hover - end